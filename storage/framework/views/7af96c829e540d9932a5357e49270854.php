...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>" class="scroll-smooth">
            ...
            <div class="max-w-7xl 2xl:max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex items-center justify-between h-16">
                    <div class="flex items-center gap-4">
                        ...
                        <a href="<?php echo e(route('home')); ?>" class="text-2xl font-bold bg-gradient-to-r from-green-500 to-orange-500 bg-clip-text text-transparent">
                            Allo Tata
                        </a>
                        <?php if($user->is_admin && config('app.debug')): ?>
                    ...
                    <div class="hidden lg:flex items-center gap-4">
                        <?php if($user->is_admin): ?>
                            <a href="<?php echo e(route('admin.index')); ?>" class="px-4 py-2 text-sm font-medium bg-red-600 hover:bg-red-700 text-white rounded-lg transition">
                                Administration
                            </a>
                        <?php endif; ?>
                        ...
                        <a href="<?php echo e(route('settings.index')); ?>" class="px-4 py-2 text-sm font-medium text-slate-700 dark:text-slate-300 hover:text-green-600 dark:hover:text-green-400 transition">
        ...
        <div class="max-w-7xl 2xl:max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 py-8 flex-1 w-full">
            ...
            <div class="mb-8">
                <h1 class="text-3xl font-bold text-slate-900 dark:text-white mb-2">
                    Bienvenue, <?php echo e($user->name); ?> !
                </h1>
            ...
            <div class="flex gap-6">
                ...
                <aside class="hidden md:flex flex-col w-16 xl:w-64 flex-shrink-0 sticky top-20 self-start h-[calc(100vh-6rem)] overflow-y-auto">
                    <nav class="bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-slate-200 dark:border-slate-700 p-2 xl:p-3 space-y-1">
                        ...
                        <button 
                            ...
                            class="sidebar-tab w-full flex items-center justify-center xl:justify-start gap-3 px-3 py-3 rounded-lg text-sm font-medium transition-all group relative <?php echo e($activeTab === 'entreprises' ? 'bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-400' : 'text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-700 hover:text-slate-900 dark:hover:text-white'); ?>"
                        ...
                        >
                            ...
                            ?>
                            <?php if(isset($entrepriseStats['reservations_en_attente']) && $entrepriseStats['reservations_en_attente'] > 0): ?>
                                <span class="xl:ml-auto px-2 py-0.5 text-xs bg-yellow-500 text-white rounded-full"><?php echo e($entrepriseStats['reservations_en_attente']); ?></span>
                            <?php endif; ?>
                        ...
                        >
                            ...
                            <?php if($nonLus > 0): ?>
                                <span class="xl:ml-auto px-2 py-0.5 text-xs bg-green-500 text-white rounded-full"><?php echo e($nonLus); ?></span>
                            <?php endif; ?>
                        ...
                        <button 
                            ...
                            class="sidebar-tab w-full flex items-center justify-center xl:justify-start gap-3 px-3 py-3 rounded-lg text-sm font-medium transition-all group relative <?php echo e($activeTab === 'notifications' ? 'bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-400' : 'text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-700 hover:text-slate-900 dark:hover:text-white'); ?>"
                        ...
                        >
                            ...
                            <?php if($user->nombre_notifications_non_lues > 0): ?>
                                <span class="xl:ml-auto px-2 py-0.5 text-xs bg-orange-500 text-white rounded-full"><?php echo e($user->nombre_notifications_non_lues); ?></span>
                            <?php endif; ?>
                        ...
                        <button 
                            ...
                            class="sidebar-tab w-full flex items-center justify-center xl:justify-start gap-3 px-3 py-3 rounded-lg text-sm font-medium transition-all group relative <?php echo e($activeTab === 'securite' ? 'bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-400' : 'text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-700 hover:text-slate-900 dark:hover:text-white'); ?>"
                            data-tab="securite"
                        >
                            <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <button 
                            ...
                            class="sidebar-tab w-full flex items-center justify-center xl:justify-start gap-3 px-3 py-3 rounded-lg text-sm font-medium transition-all group relative <?php echo e($activeTab === 'support' ? 'bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-400' : 'text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-700 hover:text-slate-900 dark:hover:text-white'); ?>"
                            data-tab="support"
                        >
                            <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <main class="flex-1 min-w-0">
                    ...
                    <div class="bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-slate-200 dark:border-slate-700 p-4 sm:p-6">
                        ...
                        <!-- Onglet Entreprises -->
                        <div id="tab-entreprises" class="tab-content <?php echo e($activeTab !== 'entreprises' ? 'hidden' : ''); ?>">
                            <?php echo $__env->make('dashboard.tabs.entreprises', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                        </div>
                        
                        <!-- Onglet Installer -->
                        <div id="tab-installer" class="tab-content <?php echo e($activeTab !== 'installer' ? 'hidden' : ''); ?>">
                            <?php echo $__env->make('dashboard.tabs.installer', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                        </div>

                        <!-- Onglet Abonnements -->
                        <div id="tab-abonnements" class="tab-content <?php echo e($activeTab !== 'abonnements' ? 'hidden' : ''); ?>">
                            <?php echo $__env->make('dashboard.tabs.abonnements', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                        </div>

                        <!-- Onglet Réservations -->
                        <?php if($user->est_client): ?>
                            <div id="tab-reservations" class="tab-content <?php echo e($activeTab !== 'reservations' ? 'hidden' : ''); ?>">
                                <?php echo $__env->make('dashboard.tabs.reservations', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                            </div>
                        <?php endif; ?>

                        <!-- Onglet Factures -->
                        <div id="tab-factures" class="tab-content <?php echo e($activeTab !== 'factures' ? 'hidden' : ''); ?>">
                            <?php echo $__env->make('dashboard.tabs.factures', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                        </div>

                        <!-- Onglet Messagerie -->
                        <div id="tab-messagerie" class="tab-content <?php echo e($activeTab !== 'messagerie' ? 'hidden' : ''); ?>">
                            <?php echo $__env->make('dashboard.tabs.messagerie', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                        </div>

                        <!-- Onglet Notifications -->
                        <div id="tab-notifications" class="tab-content <?php echo e($activeTab !== 'notifications' ? 'hidden' : ''); ?>">
                            <?php echo $__env->make('dashboard.tabs.notifications', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                        </div>

                        <!-- Onglet Sécurité -->
                        <div id="tab-securite" class="tab-content <?php echo e($activeTab !== 'securite' ? 'hidden' : ''); ?>">
                            <?php echo $__env->make('dashboard.tabs.securite', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                        </div>

                        <!-- Onglet Support -->
                        <div id="tab-support" class="tab-content <?php echo e($activeTab !== 'support' ? 'hidden' : ''); ?>">
                            <?php echo $__env->make('dashboard.tabs.support', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                        </div>
                    </div>
                </main>
            </div>
    ...
    <?php echo $__env->make('partials.pwa-install-banner', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
