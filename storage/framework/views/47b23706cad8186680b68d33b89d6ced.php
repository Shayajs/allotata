            ...
            <div id="agenda-subtab-content-parametres" class="agenda-subtab-content hidden">
                ...
                <div class="bg-white dark:bg-slate-800 rounded-2xl shadow-xl border border-slate-200 dark:border-slate-700 p-4 sm:p-6 mb-6 sm:mb-8">
                    ...
                    <form action="<?php echo e(route('agenda.horaires.store', $entreprise->slug)); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        <div class="space-y-3">
                            <?php
                            ...
                            <?php for($i = 0; $i < 7; $i++): ?>
                                ...
                                ?>
                                <div class="jour-horaires p-3 sm:p-4 border border-slate-200 dark:border-slate-700 rounded-xl hover:bg-slate-50 dark:hover:bg-slate-700/50 transition-colors" data-jour="<?php echo e($i); ?>">
                                    <div class="flex flex-wrap items-center gap-2 sm:gap-4 mb-3">
                                        <div class="w-24 sm:w-28 flex-shrink-0">
                                            <span class="font-semibold text-sm sm:text-base text-slate-900 dark:text-white"><?php echo e($jours[$i]); ?></span>
                                        </div>
                                        <label class="flex items-center gap-2 cursor-pointer flex-shrink-0">
                                            <input 
                                                type="checkbox" 
                                                name="horaires[<?php echo e($i); ?>][ferme]" 
                                                value="1"
                                                ...
                                                <?php echo e($isFerme ? 'checked' : ''); ?>

                                            >
                                            <span class="text-xs sm:text-sm text-red-600 dark:text-red-400 font-medium">Fermé</span>
                                        </label>
                                        <input type="hidden" name="horaires[<?php echo e($i); ?>][jour_semaine]" value="<?php echo e($i); ?>">
                                        <?php if($isFerme): ?>
                                            <input type="hidden" name="horaires[<?php echo e($i); ?>][plages]" value="">
                                        <?php endif; ?>
                                        <button 
                                            type="button" 
                                            ...
                                            data-jour="<?php echo e($i); ?>"
                                            style="<?php echo e($isFerme ? 'display: none;' : ''); ?>"
                                        >
                                            + Ajouter une plage
                                        </button>
                                    </div>
                                    <div class="plages-container" data-jour="<?php echo e($i); ?>">
                                        <?php if($isFerme): ?>
                                            <div class="text-xs sm:text-sm text-slate-500 dark:text-slate-400 italic">Jour fermé</div>
                                        <?php else: ?>
                                            <?php $__currentLoopData = $horairesJour; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $plage): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div class="plage-item flex flex-wrap items-center gap-2 sm:gap-3 mb-2">
                                                    <div class="flex items-center gap-2 flex-1 min-w-0">
                                                        ...
                                                        <input 
                                                            type="time" 
                                                            name="horaires[<?php echo e($i); ?>][plages][<?php echo e($loop->index); ?>][heure_ouverture]" 
                                                            value="<?php echo e($plage->heure_ouverture ? \Carbon\Carbon::parse($plage->heure_ouverture)->format('H:i') : ''); ?>"
                                                        ...
                                                        <input 
                                                            type="time" 
                                                            name="horaires[<?php echo e($i); ?>][plages][<?php echo e($loop->index); ?>][heure_fermeture]" 
                                                            value="<?php echo e($plage->heure_fermeture ? \Carbon\Carbon::parse($plage->heure_fermeture)->format('H:i') : ''); ?>"
                                                            class="px-2 sm:px-3 py-1.5 sm:py-2 border border-slate-300 dark:border-slate-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 bg-white dark:bg-slate-700 text-slate-900 dark:text-white text-sm sm:text-base flex-1 min-w-0"
                                                            required
                                                        >
                                                    </div>
                ...
                <div class="bg-white dark:bg-slate-800 rounded-2xl shadow-xl border border-slate-200 dark:border-slate-700 p-4 sm:p-6">
                    ...
                    <?php if(count($exceptionsGrouped) > 0): ?>
                        <div class="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
                            <?php $__currentLoopData = $exceptionsGrouped; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $horaire): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="p-3 sm:p-4 border border-slate-200 dark:border-slate-700 rounded-xl flex items-center justify-between bg-slate-50 dark:bg-slate-700/50">
                                    <div class="flex-1 min-w-0">
                                        <p class="font-semibold text-sm sm:text-base text-slate-900 dark:text-white">
                                            <?php if($horaire->isTypeJour()): ?>
                                                <?php echo e($horaire->date_exception ? \Carbon\Carbon::parse($horaire->date_exception)->locale('fr')->isoFormat('dddd D MMM') : 'Jour exceptionnel'); ?>

                                            <?php elseif($horaire->isTypeMois()): ?>
                                                <?php echo e($horaire->getTypeDescription()); ?>

                                            <?php elseif($horaire->isTypePlage()): ?>
                                                <?php echo e($horaire->getTypeDescription()); ?>

                                            <?php elseif($horaire->isTypeJoursFeries()): ?>
                                                <?php echo e($horaire->getTypeDescription()); ?>

                                            <?php else: ?>
                                                <?php echo e($horaire->date_exception ? \Carbon\Carbon::parse($horaire->date_exception)->locale('fr')->isoFormat('dddd D MMM') : 'Exception'); ?>

                                            <?php endif; ?>
                                        </p>
                                        <p class="text-xs sm:text-sm <?php echo e($horaire->heure_ouverture ? 'text-slate-600 dark:text-slate-400' : 'text-red-600 dark:text-red-400'); ?>">
                                            <?php if($horaire->heure_ouverture && $horaire->heure_fermeture): ?>
                                        ...
                                        <?php if($horaire->isTypeMois() && count($horaire->getJoursExclus()) > 0): ?>
                                            <p class="text-xs text-slate-500 dark:text-slate-400 mt-1">
                                                Exclu: <?php echo e(implode(', ', array_map(function($j) { return \App\Models\HorairesOuverture::getJoursSemaine()[$j] ?? ''; }, $horaire->getJoursExclus()))); ?>

                                            </p>
                                        <?php endif; ?>
                                    </div>
                                    <form action="<?php echo e(route('agenda.jour-exceptionnel.delete', [$entreprise->slug, $horaire->id])); ?>" method="POST" onsubmit="return confirm('Supprimer cette exception ?');" class="ml-2 flex-shrink-0">
                                        <?php echo csrf_field(); ?>
            ...
            <div id="modal-jour-exceptionnel" class="hidden fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 overflow-y-auto p-4">
                <div class="bg-white dark:bg-slate-800 rounded-2xl shadow-2xl p-6 max-w-lg w-full max-h-[90vh] overflow-y-auto">
                    ...
                    <form action="<?php echo e(route('agenda.jour-exceptionnel.store', $entreprise->slug)); ?>" method="POST" id="form-jour-exceptionnel">
                        <?php echo csrf_field(); ?>
                            ...
                            <div id="fields-mois" class="exception-type-fields hidden">
                                ...
                                <div class="mt-4">
                                    ...
                                    <div class="grid grid-cols-2 gap-2">
                                        ...
                                        ?>
                                        <?php $__currentLoopData = $joursSemaine; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $num => $nom): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <label class="flex items-center gap-2 p-2 rounded-lg hover:bg-slate-100 dark:hover:bg-slate-700 cursor-pointer">
                                                ...
                                                >
                                                <span class="text-sm text-slate-700 dark:text-slate-300"><?php echo e($nom); ?></span>
                                            </label>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </div>
                                </div>
...
<script>
    ...
    const reservationsUrl = '<?php echo e(route("agenda.reservations", $entreprise->slug, false)); ?>';
    const entrepriseSlug = '<?php echo e($entreprise->slug); ?>';
    const reservationShowBaseUrl = '<?php echo e(url("/m/" . $entreprise->slug . "/reservations")); ?>';
