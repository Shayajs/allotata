                ...
                >
                    ...
                    <?php if(isset($typesServices)): ?>
                        <?php $__currentLoopData = $typesServices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $typeService): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($typeService->id); ?>" data-prix="<?php echo e($typeService->prix); ?>" data-duree="<?php echo e($typeService->duree_minutes); ?>">
                                <?php echo e($typeService->nom); ?> - <?php echo e(number_format($typeService->prix, 2, ',', ' ')); ?> € (<?php echo e($typeService->duree_minutes); ?> min)
                            </option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    <?php endif; ?>
                </select>
