        ...
        <div class="flex min-h-screen items-center justify-center p-3 sm:p-4 text-center">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2">
                ...
                <div class="p-4 sm:p-6 lg:p-8 order-1">
                    ...
                    <form action="<?php echo e(route('agenda.service.store', $entreprise->slug)); ?>" method="POST" enctype="multipart/form-data" id="service-form">
                        <?php echo csrf_field(); ?>
...
<script>
    ...
    async function uploadImagesImmediately(files) {
        ...
        const url = '<?php echo e(route("agenda.service.image.upload", ["slug" => $entreprise->slug, "typeServiceId" => ":serviceId"])); ?>'
    ...
    function setImageAsCover(serviceId, imageId, isCurrentlyCover) {
        ...
        const url = '<?php echo e(route("agenda.service.image.cover", ["slug" => $entreprise->slug, "typeServiceId" => ":serviceId", "imageId" => ":imageId"])); ?>'
    ...
    function deleteServiceImage(serviceId, imageId) {
        ...
        const url = '<?php echo e(route("agenda.service.image.delete", ["slug" => $entreprise->slug, "typeServiceId" => ":serviceId", "imageId" => ":imageId"])); ?>'
            .replace(':serviceId', serviceId)
            .replace(':imageId', imageId);
...
<?php /**PATH /var/www/html/resources/views/entreprise/dashboard/tabs/services-modal-content.blade.php ENDPATH**/ ?>