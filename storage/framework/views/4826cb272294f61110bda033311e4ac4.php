...
<div>
            ...
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-sm text-red-700 dark:text-red-400">
                        ...
                        <?php if($lockout->locked_until): ?>
                            Vous pourrez réessayer dans <?php echo e(now()->diffInMinutes($lockout->locked_until, false)); ?> minute(s).
                        <?php endif; ?>
                    </p>
                </div>
            </div>
    ...
    <div class="mb-8">
        ...
        <div class="bg-slate-50 dark:bg-slate-700/50 rounded-lg p-4">
            <form action="<?php echo e(route('security.a2f.update')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <div class="space-y-4">
                    <label class="flex items-center gap-3 cursor-pointer">
                        <input type="checkbox" name="a2f_enabled" value="1" 
                               <?php echo e($user->a2f_enabled ? 'checked' : ''); ?>
                    ...
                    <div id="a2f-method-container" class="<?php echo e($user->a2f_enabled ? '' : 'hidden'); ?> space-y-3">
                        ...
                        <label class="flex items-center gap-3 cursor-pointer">
                            <input type="checkbox" name="a2f_methods[]" value="email" 
                                   <?php echo e(($user->a2f_method_email ?? true) ? 'checked' : ''); ?>
                        ...
                        <label class="flex items-center gap-3 cursor-pointer">
                            <input type="checkbox" name="a2f_methods[]" value="sms" 
                                   <?php echo e(($user->a2f_method_sms ?? false) ? 'checked' : ''); ?>

                                   class="w-4 h-4 text-green-600 border-slate-300 focus:ring-green-500 rounded"
                                   <?php echo e(!$user->telephone ? 'disabled' : ''); ?>>
                            <div>
    ...
    <div class="mb-8">
        ...
        <div class="bg-slate-50 dark:bg-slate-700/50 rounded-lg p-4">
            ...
            <?php if(class_exists('\PragmaRX\Google2FA\Google2FA') && $user->hasGoogle2faEnabled()): ?>
                <div class="space-y-4">
                    ...
                    ?>
                    <?php if(!empty($recoveryCodesWithStatus)): ?>
                        <div class="p-4 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg">
                            ...
                            <div class="grid grid-cols-2 md:grid-cols-4 gap-2 mt-4">
                                <?php $__currentLoopData = $recoveryCodesWithStatus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $codeData): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="p-3 bg-white dark:bg-slate-800 rounded-lg border <?php echo e($codeData['used'] ? 'border-red-300 dark:border-red-700 opacity-60' : 'border-slate-200 dark:border-slate-700'); ?>">
                                        <div class="flex items-center justify-between">
                                            <code class="font-mono text-sm <?php echo e($codeData['used'] ? 'line-through text-slate-400 dark:text-slate-500' : 'text-slate-900 dark:text-white font-bold'); ?>">
                                                <?php echo e($codeData['code']); ?>

                                            </code>
                                            <?php if($codeData['used']): ?>
                                                <span class="text-xs text-red-600 dark:text-red-400 ml-2" title="Utilisé le <?php echo e($codeData['used_at'] ? $codeData['used_at']->format('d/m/Y à H:i') : 'N/A'); ?>">
                                        ...
                                        <?php if($codeData['used'] && $codeData['used_at']): ?>
                                            <p class="text-xs text-slate-500 dark:text-slate-400 mt-1">
                                                Utilisé le <?php echo e($codeData['used_at']->format('d/m/Y H:i')); ?>
    ...
    <div class="mb-8">
        ...
        <div class="bg-slate-50 dark:bg-slate-700/50 rounded-lg p-4">
            <form action="<?php echo e(route('security.recovery-method.update')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <div class="space-y-3">
                    <label class="flex items-center gap-3 cursor-pointer">
                        <input type="checkbox" name="recovery_methods[]" value="email" 
                               <?php echo e(($user->recovery_method_email ?? true) ? 'checked' : ''); ?>
                    ...
                    <label class="flex items-center gap-3 cursor-pointer">
                        <input type="checkbox" name="recovery_methods[]" value="sms" 
                               <?php echo e(($user->recovery_method_sms ?? false) ? 'checked' : ''); ?>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
        <div class="bg-slate-50 dark:bg-slate-700/50 rounded-lg p-4">
            ...
            <p class="text-2xl font-bold text-slate-900 dark:text-white"><?php echo e($stats['total_login_attempts']); ?></p>
        </div>
        <div class="bg-slate-50 dark:bg-slate-700/50 rounded-lg p-4">
            <p class="text-sm text-slate-600 dark:text-slate-400 mb-1">Connexions réussies</p>
            <p class="text-2xl font-bold text-green-600 dark:text-green-400"><?php echo e($stats['successful_logins']); ?></p>
        </div>
        <div class="bg-slate-50 dark:bg-slate-700/50 rounded-lg p-4">
            <p class="text-sm text-slate-600 dark:text-slate-400 mb-1">Échecs de connexion</p>
            <p class="text-2xl font-bold text-red-600 dark:text-red-400"><?php echo e($stats['failed_attempts']); ?></p>
        </div>
        <div class="bg-slate-50 dark:bg-slate-700/50 rounded-lg p-4">
            <p class="text-sm text-slate-600 dark:text-slate-400 mb-1">Activités suspectes (30j)</p>
            <p class="text-2xl font-bold <?php echo e($stats['suspicious_logs'] > 0 ? 'text-red-600 dark:text-red-400' : 'text-slate-900 dark:text-white'); ?>"><?php echo e($stats['suspicious_logs']); ?></p>
        </div>
    </div>
                ...
                <div class="overflow-x-auto">
                    <table class="w-full">
                        ...
                        <tbody class="divide-y divide-slate-200 dark:divide-slate-700">
                            <?php $__currentLoopData = $loginAttempts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $attempt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td class="px-4 py-3 text-sm text-slate-900 dark:text-white">
                                        <?php echo e($attempt->attempted_at->format('d/m/Y H:i')); ?>
                                    ...
                                    <td class="px-4 py-3 text-sm text-slate-600 dark:text-slate-400">
                                        <?php echo e($attempt->failure_reason ? ucfirst(str_replace('_', ' ', $attempt->failure_reason)) : '-'); ?>
            ...
            <?php if($ipHistory->count() > 0): ?>
                <div class="overflow-x-auto">
                    <table class="w-full">
                        ...
                        <tbody class="divide-y divide-slate-200 dark:divide-slate-700">
                            <?php $__currentLoopData = $ipHistory; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ip): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td class="px-4 py-3 text-sm text-slate-600 dark:text-slate-400">
                                        <?php echo e($ip->location ?? 'Inconnue'); ?>

                                    </td>
                                    <td class="px-4 py-3 text-sm text-slate-600 dark:text-slate-400">
                                        <?php echo e($ip->first_seen_at->format('d/m/Y')); ?>

                                    </td>
                                    <td class="px-4 py-3 text-sm text-slate-600 dark:text-slate-400">
                                        <?php echo e($ip->last_seen_at->format('d/m/Y H:i')); ?>

                                    </td>
                                    <td class="px-4 py-3 text-sm text-slate-600 dark:text-slate-400">
                                        <?php echo e($ip->login_count); ?>
    ...
    <div>
        ...
        <div class="space-y-3">
            <?php if($securityLogs->count() > 0): ?>
                <?php $__currentLoopData = $securityLogs->take(20); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $log): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="bg-white dark:bg-slate-800 rounded-lg border border-slate-200 dark:border-slate-700 p-4">
                        <div class="flex items-start justify-between">
                            <div class="flex-1">
                                <div class="flex items-center gap-3 mb-2">
                                    <span class="px-2 py-1 text-xs font-medium rounded-full
                                        <?php if($log->severity === 'critical'): ?> bg-red-100 dark:bg-red-900/30 text-red-700 dark:text-red-400
                                        <?php elseif($log->severity === 'high'): ?> bg-orange-100 dark:bg-orange-900/30 text-orange-700 dark:text-orange-400
                                        <?php elseif($log->severity === 'medium'): ?> bg-yellow-100 dark:bg-yellow-900/30 text-yellow-700 dark:text-yellow-400
                                ...
                                <?php if($log->description): ?>
                                    <p class="text-sm text-slate-600 dark:text-slate-400 mb-2"><?php echo e($log->description); ?></p>
                                <?php endif; ?>
                                <div class="flex items-center gap-4 text-xs text-slate-500 dark:text-slate-500">
                                    <span><?php echo e($log->created_at->format('d/m/Y H:i')); ?></span>
                                    <span><?php echo e($log->ip_address); ?></span>
                                    <?php if($log->location): ?>
                                        <span><?php echo e($log->location); ?></span>
                                    <?php endif; ?>
                                </div>
                            </div>
                        </div>
        ...
        <div class="bg-white dark:bg-slate-800 rounded-xl shadow-xl max-w-2xl w-full max-h-[90vh] overflow-hidden flex flex-col">
            ...
            <div class="overflow-y-auto flex-1 p-6">
                ...
                <div id="google2fa-disable-content" class="hidden space-y-4">
                    ...
                    <form action="<?php echo e(route('security.google2fa.disable')); ?>" method="POST" id="disable-google2fa-form">
                        <?php echo csrf_field(); ?>
                        <div>
                ...
                <div id="google2fa-recovery-content" class="hidden space-y-4">
                    ...
                    <form action="<?php echo e(route('security.google2fa.recovery-codes')); ?>" method="POST" id="recovery-codes-form">
                        <?php echo csrf_field(); ?>
                        <div>
    ...
    <script>
        ...
        async function submitEnableGoogle2FA() {
            ...
            try {
                ...
                const response = await fetch('<?php echo e(route("security.google2fa.enable")); ?>', {
                    method: 'POST',
                    body: formData,
                    headers: {
        ...
        async function setupGoogle2FA() {
            try {
                const response = await fetch('<?php echo e(route("security.google2fa.generate")); ?>', {
                    method: 'POST',
                    headers: {
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            <?php if(session('recovery_codes')): ?>
                const recoveryCodes = <?php echo json_encode(session('recovery_codes'), 15, 512) ?>;
                const recoveryCodesList = document.getElementById('recovery-codes-list');
...
<?php /**PATH /var/www/html/resources/views/dashboard/tabs/securite.blade.php ENDPATH**/ ?>