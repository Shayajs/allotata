    ...
    <div class="max-w-7xl mx-auto">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
            ...
            <div>
                ...
                <ul class="space-y-2">
                    <li><a href="<?php echo e(route('pages.fonctionnalites')); ?>" class="hover:text-green-400 transition">Fonctionnalités</a></li>
                    <li><a href="<?php echo e(route('courses.index')); ?>" class="hover:text-green-400 transition">Apprendre Allotata</a></li>
                    <?php if(auth()->guard()->check()): ?>
                        <li><a href="<?php echo e(route('dashboard')); ?>" class="hover:text-green-400 transition">Dashboard</a></li>
                    <?php else: ?>
                        <?php if(Route::has('login')): ?>
                            <li><a href="<?php echo e(route('login')); ?>" class="hover:text-green-400 transition">Connexion</a></li>
                        <?php endif; ?>
                        <?php if(Route::has('signup')): ?>
                            <li><a href="<?php echo e(route('signup')); ?>" class="hover:text-green-400 transition">Inscription</a></li>
                        <?php endif; ?>
                    <?php endif; ?>
                </ul>
            </div>
            <div>
                ...
                <ul class="space-y-2">
                    <li><a href="<?php echo e(route('pages.about')); ?>" class="hover:text-green-400 transition">À propos</a></li>
                    <li><a href="<?php echo e(route('legal.mentions')); ?>" class="hover:text-green-400 transition">Mentions Légales</a></li>
                    <li><a href="<?php echo e(route('legal.confidentialite')); ?>" class="hover:text-green-400 transition">Politique de Confidentialité</a></li>
                    <li><a href="<?php echo e(route('legal.cgu')); ?>" class="hover:text-green-400 transition">C.G.U.</a></li>
                    <li><a href="<?php echo e(route('legal.cgv')); ?>" class="hover:text-green-400 transition">C.G.V.</a></li>
                    <li><a href="<?php echo e(route('forum.index')); ?>" class="hover:text-green-400 transition">Forum</a></li>
                    <li><a href="<?php echo e(route('feedback.index')); ?>" class="hover:text-green-400 transition">Feedback</a></li>
                    <li><a href="<?php echo e(route('dev.index')); ?>" class="hover:text-green-400 transition">Documentation</a></li>
                    <li>
        ...
        <div class="border-t border-slate-800 pt-8 text-center text-slate-500">
            <p>&copy; <?php echo e(date('Y')); ?> Allo Tata. Tous droits réservés.</p>
        </div>
    </div>
</footer>
        ...
        <div class="bg-white dark:bg-slate-800 rounded-xl shadow-2xl w-full max-w-md p-6" onclick="event.stopPropagation()">
            ...
            <?php if(session('contact_success')): ?>
                <div class="mb-4 p-3 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg">
                    <p class="text-sm text-green-800 dark:text-green-300"><?php echo e(session('contact_success')); ?></p>
                </div>
            <?php endif; ?>
            ...
            <form action="<?php echo e(route('contact.store')); ?>" method="POST" class="space-y-4">
                ...
                <div>
                    ...
                    <input 
                        type="text" 
                        name="nom" 
                        value="<?php echo e(old('nom', auth()->user()->name ?? '')); ?>"
                        required
