...
<section class="py-16 md:py-24 px-4" style="background: var(--site-background);" id="contact">
    <div class="max-w-4xl mx-auto">
        ...
        <div class="grid grid-cols-1 <?php echo e(($showMap && $hasCoordinates) ? 'md:grid-cols-2 gap-8' : ''); ?>">
            
            <div class="space-y-6">
                <?php if($showEmail && $entreprise->email): ?>
                    <a href="mailto:<?php echo e($entreprise->email); ?>" 
                       ...
                       style="background: linear-gradient(135deg, var(--site-primary), var(--site-secondary)); box-shadow: var(--site-button-shadow);">
                        ...
                        <div>
                            ...
                            <p class="text-white font-semibold"><?php echo e($entreprise->email); ?></p>
                        </div>
                    </a>
                <?php endif; ?>
                
                <?php if($showPhone && $entreprise->telephone): ?>
                    <a href="tel:<?php echo e($entreprise->telephone); ?>" 
                       ...
                       style="border-color: var(--site-primary);">
                        ...
                        <div>
                            ...
                            <p class="font-semibold" style="color: var(--site-text);"><?php echo e($entreprise->telephone); ?></p>
                        </div>
                    </a>
                <?php endif; ?>
                
                <?php if($showAddress && ($entreprise->ville || $entreprise->formatted_address)): ?>
                    <div class="flex items-center gap-4 p-4 rounded-xl bg-slate-100 dark:bg-slate-800">
                        ...
                        <div>
                            ...
                            <p class="font-semibold" style="color: var(--site-text);"><?php echo e($entreprise->formatted_address); ?></p>
                            <?php if($entreprise->estMobile()): ?>
                                <p class="text-sm text-slate-500 dark:text-slate-400">
                                    Se déplace dans un rayon de <?php echo e($entreprise->rayon_deplacement); ?> km
                                </p>
                            <?php endif; ?>
                        </div>
                    </div>
...
<?php /**PATH /var/www/html/resources/views/components/site-web/blocks/contact.blade.php ENDPATH**/ ?>