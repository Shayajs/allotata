...
<head>
    ...
    <title>Boutique - <?php echo e($entreprise->nom); ?></title>
        ...
        <header class="mb-8">
            <div class="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p class="text-slate-600 dark:text-slate-400"><?php echo e($entreprise->nom); ?> • Découvrez nos produits</p>
                </div>
            </div>
        </header>
                ...
                <div class="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
                    <?php $__currentLoopData = $produits; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $produit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div 
                            ...
                            onclick="openProduitModal(<?php echo e($loop->index); ?>)"
                        ...
                        >
                            ...
                            <div class="p-4 sm:p-6">
                                ...
                                <div class="flex flex-col gap-3 pt-4 border-t border-slate-200 dark:border-slate-700">
                                        ...
                                        <div class="flex flex-col">
                                            <?php if($promotion): ?>
                                                <div class="flex items-center gap-2">
                                                    <span class="text-lg line-through text-slate-400"><?php echo e(number_format($produit->prix, 2, ',', ' ')); ?> €</span>
                                            ...
                                            <?php elseif($produit->stock): ?>
                                                <span class="text-xs text-slate-500 dark:text-slate-400 mt-1">En stock: <?php echo e($produit->stock->quantite_disponible); ?></span>
                                            <?php endif; ?>
                                        </div>
                                    ...
                                    <?php else: ?>
                                        <a href="<?php echo e(route('login')); ?>?redirect=<?php echo e(urlencode(route('public.store', $entreprise->slug))); ?>" onclick="event.stopPropagation();" class="w-full inline-flex items-center justify-center gap-2 px-4 py-2.5 bg-gradient-to-r from-green-600 to-green-500 hover:from-green-700 hover:to-green-600 text-white font-bold rounded-lg transition text-sm">
                ...
                <div class="flex flex-col lg:flex-row h-[calc(100vh-4rem)] max-h-[800px]">
                    ...
                    <div class="lg:w-1/2 flex flex-col overflow-y-auto">
                        <div class="p-4 sm:p-6">
                            ...
                            <!-- Actions -->
                            <?php if($entreprise->livraison_disponible): ?>
    ...
    <script>
        ...
        const produitsData = [
            ...
            ?>
            {
                ...
                nom: "<?php echo e(addslashes($produit->nom)); ?>",
                description: "<?php echo e(addslashes($produit->description ?? '')); ?>",
                prix: "<?php echo e(number_format($produit->prix, 2, ',', ' ')); ?>",
                prixActuel: "<?php echo e(number_format($prixActuel, 2, ',', ' ')); ?>",
                aPromotion: <?php echo e($promotion ? 'true' : 'false'); ?>,
                stock: "<?php echo e($produit->gestion_stock === 'en_attente_commandes' ? 'En attente de commandes' : ($produit->stock ? 'En stock: ' . $produit->stock->quantite_disponible : 'Disponible')); ?>",
                images: [
        ...
        function updateProduitModal() {
            ...
            if (commanderLinkModal) {
                const baseUrl = "<?php echo e(route('messagerie.commander-produit', [$entreprise->slug, 'produitId' => 0])); ?>";
...
<?php /**PATH /var/www/html/resources/views/public/store.blade.php ENDPATH**/ ?>