    ...
    <div class="bg-gradient-to-br from-slate-900 to-slate-800 rounded-2xl p-8 text-white relative overflow-hidden group">
        ...
        <div class="relative z-10 flex flex-col md:flex-row items-center gap-8">
            <div class="bg-white/10 p-4 rounded-2xl backdrop-blur-sm border border-white/10">
                <img src="<?php echo e(route('manifest.icon', ['slug' => $entreprise->slug, 'size' => 192])); ?>" alt="App Icon" class="w-24 h-24 rounded-xl shadow-2xl">
            </div>
            
            <div class="flex-1 text-center md:text-left">
                <div class="flex items-center justify-center md:justify-start gap-3 mb-2">
                    <h3 class="text-2xl font-bold text-white">App <?php echo e($entreprise->nom); ?></h3>

                </div>
                <p class="text-slate-300 mb-6 max-w-xl">
                    Installez l'application officielle <?php echo e($entreprise->nom); ?> sur votre appareil pour un accès direct à votre espace client, vos réservations et vos documents.
                </p>
...
<?php /**PATH /var/www/html/resources/views/entreprise/dashboard/tabs/installer.blade.php ENDPATH**/ ?>