<div>
            ...
            <div>
                ...
                <?php if($entreprise->logo): ?>
                    <div class="mb-4 relative inline-block">
                        ...
                        >
                        <form action="<?php echo e(route('settings.entreprise.logo.delete', $entreprise->slug)); ?>" method="POST" class="mt-2">
                            <?php echo csrf_field(); ?>
                ...
                <form action="<?php echo e(route('settings.entreprise.logo.upload', $entreprise->slug)); ?>" method="POST" enctype="multipart/form-data" id="logo-form">
                    <?php echo csrf_field(); ?>
                    <input 
                        type="file" 
                        name="logo" 
            ...
            <div>
                ...
                <?php if($entreprise->image_fond): ?>
                    <div class="mb-4 relative inline-block">
                        ...
                        >
                        <form action="<?php echo e(route('settings.entreprise.image-fond.delete', $entreprise->slug)); ?>" method="POST" class="mt-2">
                            <?php echo csrf_field(); ?>
                            <?php echo method_field('DELETE'); ?>
                            <button 
                                type="submit"
                ...
                <form action="<?php echo e(route('settings.entreprise.image-fond.upload', $entreprise->slug)); ?>" method="POST" enctype="multipart/form-data" id="image-fond-form">
                    <?php echo csrf_field(); ?>
                    <input 
                        type="file" 
                        name="image_fond" 
    ...
    <form id="parametres-form" action="<?php echo e(route('settings.entreprise.update', $entreprise->slug)); ?>" method="POST" class="space-y-6">
        <?php echo csrf_field(); ?>
        ...
        <div class="bg-slate-50 dark:bg-slate-700/50 rounded-xl p-6">
            ...
            <div class="mb-6 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-xl p-4">
                ...
                <?php if($entreprise->video_url): ?>
                    <div class="mb-4 p-3 bg-white dark:bg-slate-800 rounded-lg border border-blue-200 dark:border-blue-700">
                        <p class="text-sm text-slate-600 dark:text-slate-400 mb-2">
                            ...
                            <a href="<?php echo e($entreprise->video_url); ?>" target="_blank" class="text-blue-600 dark:text-blue-400 hover:underline break-all">
                                <?php echo e(strlen($entreprise->video_url) > 60 ? substr($entreprise->video_url, 0, 60) . '...' : $entreprise->video_url); ?>
                ...
                <div class="mb-4">
                    ...
                    <input 
                        ...
                        name="video_url" 
                        id="video_url"
                        value="<?php echo e(old('video_url', $entreprise->video_url)); ?>"
                ...
                <label class="flex items-center gap-3 p-3 border border-slate-200 dark:border-slate-600 rounded-lg cursor-pointer hover:bg-white dark:hover:bg-slate-700 transition">
                    <input 
                        ...
                        id="afficher_video"
                        value="1"
                        <?php echo e(old('afficher_video', $entreprise->afficher_video ?? true) ? 'checked' : ''); ?>
            ...
            <div class="space-y-4">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input 
                            ...
                            name="adresse_rue" 
                            id="adresse_rue"
                            value="<?php echo e(old('adresse_rue', $entreprise->adresse_rue)); ?>"
                    ...
                    <div>
                        ...
                        <input 
                            ...
                            name="code_postal" 
                            id="code_postal"
                            value="<?php echo e(old('code_postal', $entreprise->code_postal)); ?>"
                            placeholder="75001"
                            maxlength="5"
                            class="w-full px-4 py-3 border border-slate-300 dark:border-slate-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 bg-white dark:bg-slate-700 text-slate-900 dark:text-white"
                        >
                ...
                <input type="hidden" name="latitude" id="latitude" value="<?php echo e(old('latitude', $entreprise->latitude)); ?>">
                <input type="hidden" name="longitude" id="longitude" value="<?php echo e(old('longitude', $entreprise->longitude)); ?>">
                ...
                <label class="flex items-center gap-3 p-4 border border-slate-200 dark:border-slate-600 rounded-lg cursor-pointer hover:bg-white dark:hover:bg-slate-700 transition">
                    <input 
                        ...
                        value="1"
                        <?php echo e(old('afficher_adresse_complete', $entreprise->afficher_adresse_complete) ? 'checked' : ''); ?>
            ...
            <div class="space-y-4">
                ...
                <label class="flex items-center gap-3 p-4 border border-slate-200 dark:border-slate-600 rounded-lg cursor-pointer hover:bg-white dark:hover:bg-slate-700 transition">
                    <input 
                        ...
                        value="1"
                        <?php echo e(old('accepter_reservations_auto', $entreprise->accepter_reservations_auto) ? 'checked' : ''); ?>
    ...
    <div class="mt-8 bg-slate-50 dark:bg-slate-700/50 rounded-xl p-6" id="google-calendar-section">
        <div class="flex items-center justify-between mb-4">
            ...
            <?php if($entreprise->aGoogleCalendar()): ?>
        ...
        <?php if(session('success') && str_contains(session('success'), 'Google')): ?>
            <div class="mb-4 p-3 bg-green-100 dark:bg-green-900/30 border border-green-300 dark:border-green-700 rounded-lg flex items-center gap-2">
                ...
                <p class="text-sm font-medium text-green-800 dark:text-green-300"><?php echo e(session('success')); ?></p>
            </div>
        <?php endif; ?>
        <?php if(session('error') && str_contains(session('error'), 'Google')): ?>
        ...
        <?php if($entreprise->aGoogleCalendar()): ?>
            <div class="p-4 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg mb-4">
                <div class="flex items-start gap-3">
                    ...
                    <div class="flex-1">
                        ...
                        <?php if($entreprise->google_token_expires_at): ?>
                            <p class="text-xs text-green-500 dark:text-green-500 mt-2">
                                Token valide jusqu'au <?php echo e($entreprise->google_token_expires_at->format('d/m/Y à H:i')); ?> (rafraîchi automatiquement)
                            </p>
                        <?php endif; ?>
                    </div>
                </div>
            ...
            <form action="<?php echo e(route('google-calendar.disconnect', $entreprise->slug)); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <button
                    type="submit"
        ...
        <?php else: ?>
            ...
            <a
                href="<?php echo e(route('google-calendar.redirect', $entreprise->slug)); ?>"
    ...
    <div class="mt-8 bg-slate-50 dark:bg-slate-700/50 rounded-xl p-6">
                ...
                <?php $__currentLoopData = $entreprise->realisationPhotos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $photo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="relative group">
                        ...
                        <div class="absolute inset-0 bg-black/60 opacity-0 group-hover:opacity-100 transition-opacity rounded-lg flex items-center justify-center">
                            <form action="<?php echo e(route('settings.entreprise.photo.delete', [$entreprise->slug, $photo->id])); ?>" method="POST">
                                <?php echo csrf_field(); ?>
                                <?php echo method_field('DELETE'); ?>
                                <button 
                                    type="submit"
        ...
        <form action="<?php echo e(route('settings.entreprise.photo.add', $entreprise->slug)); ?>" method="POST" enctype="multipart/form-data" class="border border-slate-200 dark:border-slate-600 rounded-lg p-4 bg-white dark:bg-slate-800">
            <?php echo csrf_field(); ?>
            <div class="space-y-4">
                <div>
                    <label class="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-2">
    ...
    <div class="mt-8 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-xl p-6">
        ...
        <div class="bg-white dark:bg-slate-800 rounded-lg p-4 border border-red-200 dark:border-red-700">
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                ...
                <?php if($entreprise->canBeArchived()): ?>
                    <button 
                        type="button"
    ...
    <div id="archive-modal" class="hidden fixed inset-0 bg-slate-900/75 backdrop-blur-sm z-50 flex items-center justify-center p-4">
        <div class="modal-content max-w-md w-full p-6">
            <div class="text-center mb-6">
                ...
                <h3 class="text-xl font-bold text-slate-900 dark:text-white mb-2">Archiver "<?php echo e($entreprise->nom); ?>" ?</h3>
            ...
            <div class="flex gap-3">
                ...
                <form action="<?php echo e(route('settings.entreprise.delete', $entreprise->slug)); ?>" method="POST" class="flex-1">
                    <?php echo csrf_field(); ?>
                    <?php echo method_field('DELETE'); ?>
                    <button 
                        type="submit"
...
<?php /**PATH /var/www/html/resources/views/entreprise/dashboard/tabs/parametres.blade.php ENDPATH**/ ?>