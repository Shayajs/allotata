...
<div class="allo-map-wrapper">
    ...
    <div 
        id="<?php echo e($mapId); ?>" 
        class="allo-tata-map rounded-xl overflow-hidden border border-slate-200 dark:border-slate-700 <?php echo e($class); ?>"
        style="height: <?php echo e($height); ?>; min-height: 250px;"
    >
    ...
    <script>
    (function() {
        const containerId = '<?php echo e($mapId); ?>';
        const markers = <?php echo json_encode($markers, 15, 512) ?>;
        const center = <?php echo json_encode($center, 15, 512) ?>;
        const zoom = <?php echo e($zoom); ?>;
        const enableClustering = <?php echo e($enableClustering ? 'true' : 'false'); ?>;
        const isSingle = <?php echo e($single ? 'true' : 'false'); ?>;
...
<?php endif; ?>
<?php /**PATH /var/www/html/resources/views/components/map-standalone.blade.php ENDPATH**/ ?>