        ...
        <div class="flex flex-col sm:flex-row items-center justify-between gap-4">
            <div class="flex-1 text-center sm:text-left">
                <p class="text-slate-600 dark:text-slate-300 text-sm">
                    ...
                    <a href="<?php echo e(route('legal.cookies')); ?>" class="text-green-600 dark:text-green-400 font-medium hover:underline">Politique relative aux cookies</a>.
                </p>
            </div>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        document.getElementById('cookie-accept').addEventListener('click', function() {
            ...
            <?php if(auth()->guard()->check()): ?>
                fetch('<?php echo e(route("settings.confidentialite.update")); ?>', {
                    method: 'POST',
                    headers: {
...
<?php /**PATH /var/www/html/resources/views/partials/cookie-banner.blade.php ENDPATH**/ ?>