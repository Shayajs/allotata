    ...
    <div class="bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 dark:from-blue-900/20 dark:via-indigo-900/20 dark:to-purple-900/20 border-2 border-blue-200 dark:border-blue-800 rounded-xl p-6 mb-8 shadow-lg">
        <div class="flex flex-col md:flex-row items-start md:items-center gap-6">
                ...
                <div class="absolute inset-0 flex items-center justify-center">
                    <div class="text-center">
                        <div class="text-2xl md:text-3xl font-bold text-blue-600 dark:text-blue-400">
                            <?php echo e($completion['percentage']); ?>%
                        </div>
            ...
            <div class="flex-1">
                ...
                <div class="space-y-3">
                    <?php $__currentLoopData = $completion['conditions']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $condition): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="flex items-center gap-3 p-3 rounded-lg <?php echo e($condition['completed'] ? 'bg-green-50 dark:bg-green-900/20' : 'bg-white dark:bg-slate-800'); ?>">
                            <?php if($condition['completed']): ?>
                            ...
                            <?php else: ?>
                                ...
                                <a href="<?php echo e($condition['route']); ?>" class="flex-1 text-sm font-medium text-slate-900 dark:text-white hover:text-blue-600 dark:hover:text-blue-400 transition">
                                    <?php echo e($condition['label']); ?>
...
<?php endif; ?>
<?php /**PATH /var/www/html/resources/views/components/entreprise-completion.blade.php ENDPATH**/ ?>