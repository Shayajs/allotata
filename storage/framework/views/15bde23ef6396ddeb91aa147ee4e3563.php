...
<head>
    ...
    <title>Agenda - <?php echo e($entreprise->nom); ?></title>
    ...
    <div class="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
        ...
        <nav class="mb-6 flex items-center justify-between">
            <a href="<?php echo e(route('public.entreprise', $entreprise->slug)); ?>" class="inline-flex items-center gap-2 text-slate-600 dark:text-slate-400 hover:text-green-600 dark:hover:text-green-400 transition">
                ...
                <span class="font-medium">Retour à <?php echo e($entreprise->nom); ?></span>
            </a>
            <button 
                id="theme-toggle"
        ...
        <header class="mb-8">
            <div class="flex items-center gap-4">
                <?php if($entreprise->logo): ?>
                    <img src="/media/<?php echo e($entreprise->logo); ?>" alt="<?php echo e($entreprise->nom); ?>" class="w-16 h-16 rounded-xl object-cover shadow-md">
                <?php endif; ?>
                <div>
                    <h1 class="text-3xl font-bold bg-gradient-to-r from-green-600 to-emerald-500 bg-clip-text text-transparent">
                        Prendre rendez-vous
                    </h1>
                    <p class="text-slate-600 dark:text-slate-400"><?php echo e($entreprise->nom); ?> • <?php echo e($entreprise->type_activite); ?></p>
                </div>
            </div>
        </header>
        ...
        <?php if(auth()->guard()->check()): ?>
            <div class="xl:hidden mb-6">
                <div class="bg-white dark:bg-slate-800 rounded-2xl shadow-xl border border-slate-200 dark:border-slate-700 p-6">
                    ...
                    <form action="<?php echo e(route('public.reservation.store', $entreprise->slug)); ?>" method="POST" id="reservation-form-mobile">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="space-y-5">
                            ...
                            <div>
                                ...
                                >
                                    ...
                                    <?php $__currentLoopData = $entreprise->typesServices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php
                                        ...
                                        <option 
                                            ...
                                            data-duree="<?php echo e($service->duree_minutes); ?>" 
                                            data-prix="<?php echo e($service->prix); ?>"
                                            data-type-structure="<?php echo e($service->type_structure ?? 'ponctuel'); ?>"
                                            data-options="<?php echo e(base64_encode(json_encode($optionsData))); ?>"
                                            <?php echo e(request('service') == $service->id || request('service') == (string)$service->id ? 'selected' : ''); ?>

                                        >
                                            <?php echo e($service->nom); ?> • <?php echo e(number_format($service->prix, 0, ',', ' ')); ?>€ <?php if(($service->type_structure ?? '') === 'date_butoire'): ?> (date butoire) <?php else: ?> • <?php echo e($service->duree_minutes); ?>min <?php endif; ?>
                                        </option>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div id="date-butoire-wrapper-mobile" class="hidden">
                                ...
                                <input type="date" name="date_butoire" id="date_butoire_mobile" min="<?php echo e(date('Y-m-d')); ?>" class="w-full px-4 py-3 text-sm border-2 border-slate-200 dark:border-slate-600 rounded-xl focus:outline-none focus:border-green-500 dark:focus:border-green-400 bg-white dark:bg-slate-700 text-slate-900 dark:text-white transition-colors">
                                <?php $__errorArgs = ['date_butoire'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <?php if($aGestionMultiPersonnes && $membres->count() > 0): ?>
                                <div>
                                    <label class="block text-sm font-semibold text-slate-700 dark:text-slate-300 mb-2">
                                        Personne
                                    </label>
                                    ...
                                    >
                                        ...
                                        <?php $__currentLoopData = $membres; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $membre): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($membre->id); ?>" <?php echo e(old('membre_id') == $membre->id ? 'selected' : ''); ?>>
                                                <?php echo e($membre->user->name); ?>
                                ...
                                <div class="grid grid-cols-2 gap-3">
                                    <div>
                                        ...
                                        <input 
                                            ...
                                            class="w-full px-4 py-3 text-sm border-2 border-slate-200 dark:border-slate-600 rounded-xl focus:outline-none focus:border-green-500 dark:focus:border-green-400 bg-white dark:bg-slate-700 text-slate-900 dark:text-white transition-colors"
                                        >
                                        <?php $__errorArgs = ['date_reservation'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div>
                                        ...
                                        <input 
                                            ...
                                            class="w-full px-4 py-3 text-sm border-2 border-slate-200 dark:border-slate-600 rounded-xl focus:outline-none focus:border-green-500 dark:focus:border-green-400 bg-white dark:bg-slate-700 text-slate-900 dark:text-white transition-colors"
                                        >
                                        <?php $__errorArgs = ['heure_reservation'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                <label class="block text-sm font-semibold text-slate-700 dark:text-slate-300 mb-2">
                                    Téléphone
                                    <?php if(isset($userInfo) && !empty($userInfo['telephone'])): ?>
                                ...
                                <input 
                                    ...
                                    required
                                    value="<?php echo e(old('telephone_client', $userInfo['telephone'] ?? '')); ?>"
                                    placeholder="06 12 34 56 78"
                                    class="w-full px-4 py-3 text-sm border-2 border-slate-200 dark:border-slate-600 rounded-xl focus:outline-none focus:border-green-500 dark:focus:border-green-400 bg-white dark:bg-slate-700 text-slate-900 dark:text-white transition-colors"
                                >
                                <?php $__errorArgs = ['telephone_client'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                <?php if(!isset($userInfo) || empty($userInfo['telephone'])): ?>
                                    <p class="mt-1 text-xs text-slate-500 dark:text-slate-400">
                                        💡 <a href="<?php echo e(route('settings.index', ['tab' => 'account'])); ?>" class="text-green-600 dark:text-green-400 hover:underline">Ajoutez votre téléphone dans vos paramètres</a> pour qu'il soit pré-rempli automatiquement.
                                    </p>
                                <?php endif; ?>
                            </div>
        ...
        <?php else: ?>
            <div class="xl:hidden mb-6 text-center py-8 bg-white dark:bg-slate-800 rounded-2xl shadow-xl border border-slate-200 dark:border-slate-700">
                ...
                <a href="<?php echo e(route('login')); ?>" class="inline-block px-6 py-3 bg-gradient-to-r from-green-600 to-emerald-500 hover:from-green-700 hover:to-emerald-600 text-white font-semibold rounded-xl transition-all shadow-lg hover:shadow-xl">
                    Se connecter
                </a>
            </div>
        <?php endif; ?>
        ...
        <?php if(session('info')): ?>
            <div class="mb-6 p-4 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-xl">
                <div class="flex items-center gap-3">
                    ...
                    <p class="text-blue-800 dark:text-blue-300 font-medium"><?php echo e(session('info')); ?></p>
                </div>
            </div>
        <?php endif; ?>
                ...
                <div class="flex items-start gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-red-700 dark:text-red-400 mt-1">
                            <a href="<?php echo e(route('settings.index', ['tab' => 'subscription'])); ?>" class="underline font-semibold">Souscrivez à un abonnement</a> pour être visible.
                        </p>
                    </div>
                </div>
            </div>
        ...
        <div class="grid grid-cols-1 xl:grid-cols-3 gap-8">
            ...
            <div class="xl:col-span-1 hidden xl:block">
                <div class="bg-white dark:bg-slate-800 rounded-2xl shadow-xl border border-slate-200 dark:border-slate-700 p-6 sticky top-6">
                    ...
                    <?php if(auth()->guard()->check()): ?>
                        <form action="<?php echo e(route('public.reservation.store', $entreprise->slug)); ?>" method="POST" id="reservation-form">
                            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div id="date-butoire-wrapper" class="hidden">
                                    <label class="block text-sm font-semibold text-slate-700 dark:text-slate-300 mb-2">Date butoire souhaitée</label>
                                    <input type="date" name="date_butoire" id="date_butoire" min="<?php echo e(date('Y-m-d')); ?>" class="w-full px-4 py-3 text-sm border-2 border-slate-200 dark:border-slate-600 rounded-xl focus:outline-none focus:border-green-500 dark:focus:border-green-400 bg-white dark:bg-slate-700 text-slate-900 dark:text-white transition-colors">
                                    <?php $__errorArgs = ['date_butoire'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            // Données PHP
            const jours = <?php echo json_encode($jours, 15, 512) ?>;
            const horaires = <?php echo json_encode($horaires, 15, 512) ?>;
            const reservationsUrl = '<?php echo e(route("public.agenda.reservations", $entreprise->slug, false)); ?>';
...
<?php /**PATH /var/www/html/resources/views/public/agenda.blade.php ENDPATH**/ ?>