            ...
            <div class="fixed top-16 left-1/2 transform -translate-x-1/2 z-50 max-w-md w-full mx-4">
                <div class="p-4 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg shadow-lg">
                    <div class="flex items-center gap-3">
                        ...
                        <p class="text-sm text-green-800 dark:text-green-300"><?php echo e(session('success')); ?></p>
                    </div>
                </div>
            </div>
            <script>
        ...
        <nav class="fixed top-0 left-0 right-0 z-50 bg-white/80 dark:bg-slate-900/80 backdrop-blur-md border-b border-slate-200 dark:border-slate-700">
                ...
                <div class="flex items-center justify-between h-16">
                    <div class="flex items-center">
                        <a href="<?php echo e(route('home')); ?>" class="flex items-center gap-3">
                            ...
                            ?>
                            <?php if($logoUrl): ?>
                                <img src="<?php echo e($logoUrl); ?>" alt="<?php echo e($siteName); ?>" class="h-8 w-auto md:h-10">
                            <?php endif; ?>
            ...
            <?php if(Route::has('login')): ?>
                    <?php if(auth()->guard()->check()): ?>
                                <a href="<?php echo e(url('/dashboard')); ?>" class="px-4 py-2 text-sm font-medium text-slate-700 dark:text-slate-300 hover:text-green-600 dark:hover:text-green-400 transition">
                            Dashboard
                        </a>
                    <?php else: ?>
                                <a href="<?php echo e(route('login')); ?>" class="px-4 py-2 text-sm font-medium text-slate-700 dark:text-slate-300 hover:text-green-600 dark:hover:text-green-400 transition">
                                    Connexion
                                </a>
                                <?php if(Route::has('signup')): ?>
                                    <a href="<?php echo e(route('signup')); ?>" class="px-4 py-2 text-sm font-medium bg-green-600 hover:bg-green-700 dark:bg-green-500 dark:hover:bg-green-600 text-white rounded-lg transition">
                                        Inscription
                            </a>
                        <?php endif; ?>
                    <?php endif; ?>
                ...
                <div class="text-center">
                    <h1 class="text-5xl sm:text-6xl lg:text-7xl font-bold mb-6">
                        ...
                        <span class="block flex items-center justify-center gap-4 flex-wrap">
                            ...
                            ?>
                            <?php if($logoUrl): ?>
                                <img src="<?php echo e($logoUrl); ?>" alt="<?php echo e($siteName); ?>" class="h-12 sm:h-16 md:h-20 lg:h-24 w-auto hidden sm:block">
                            <?php endif; ?>
                    ...
                    <div class="max-w-3xl mx-auto mb-10">
                        <form action="<?php echo e(route('search')); ?>" method="GET" class="relative" id="search-form" onsubmit="if(this.querySelector('#search-input-home').value.trim()) saveSearchHistory(this.querySelector('#search-input-home').value.trim());">
                            <div class="relative">
                                <input 
                                    type="text" 
                                    name="q" 
                    ...
                    <div class="flex flex-col sm:flex-row gap-4 justify-center">
                        <?php if(auth()->guard()->check()): ?>
                            <a href="<?php echo e(route('dashboard')); ?>" class="px-8 py-4 bg-gradient-to-r from-green-600 to-green-500 hover:from-green-700 hover:to-green-600 text-white font-semibold rounded-xl shadow-lg hover:shadow-xl transition-all transform hover:-translate-y-1 flex items-center justify-center gap-2">
                        ...
                        <?php else: ?>
                            <?php if(Route::has('signup')): ?>
                                <a href="<?php echo e(route('signup')); ?>" class="px-8 py-4 bg-gradient-to-r from-green-600 to-green-500 hover:from-green-700 hover:to-green-600 text-white font-semibold rounded-xl shadow-lg hover:shadow-xl transition-all transform hover:-translate-y-1">
        ...
        <?php if(auth()->guard()->check()): ?>
            <section class="py-20 px-4 sm:px-6 lg:px-8 bg-white dark:bg-slate-800">
                <div class="max-w-6xl mx-auto">
                    ...
                    <div class="grid grid-cols-1 <?php echo e(($user->est_client && isset($miniStats['client']) && $user->est_gerant && isset($miniStats['gerant'])) ? 'md:grid-cols-2' : 'max-w-2xl mx-auto'); ?> gap-6">
                        <?php if($user->est_client && isset($miniStats['client'])): ?>
                            <!-- Section Client -->
                            <div class="bg-gradient-to-br from-green-50 to-green-100/50 dark:from-green-900/20 dark:to-green-800/10 rounded-2xl border border-green-200 dark:border-green-800 p-6">
                                ...
                                <div class="space-y-4">
                                    <div class="flex items-center justify-between pb-3 border-b border-green-200 dark:border-green-800">
                                        ...
                                        <span class="text-2xl font-bold text-slate-900 dark:text-white"><?php echo e($miniStats['client']['total_reservations']); ?></span>
                                    </div>
                                    <div class="flex items-center justify-between pb-3 border-b border-green-200 dark:border-green-800">
                                        <span class="text-slate-600 dark:text-slate-400">En attente</span>
                                        <span class="text-xl font-semibold text-yellow-600 dark:text-yellow-400"><?php echo e($miniStats['client']['reservations_en_attente']); ?></span>
                                    </div>
                                    <div class="flex items-center justify-between pb-3 border-b border-green-200 dark:border-green-800">
                                        <span class="text-slate-600 dark:text-slate-400">Confirmées</span>
                                        <span class="text-xl font-semibold text-green-600 dark:text-green-400"><?php echo e($miniStats['client']['reservations_confirmees']); ?></span>
                                    </div>
                                    <div class="flex items-center justify-between pb-3 border-b border-green-200 dark:border-green-800">
                                        <span class="text-slate-600 dark:text-slate-400">Terminées</span>
                                        <span class="text-xl font-semibold text-blue-600 dark:text-blue-400"><?php echo e($miniStats['client']['reservations_terminees']); ?></span>
                                    </div>
                                    <div class="flex items-center justify-between pb-3 border-b border-green-200 dark:border-green-800">
                                        <span class="text-slate-600 dark:text-slate-400">Ce mois</span>
                                        <span class="text-xl font-semibold text-slate-900 dark:text-white"><?php echo e($miniStats['client']['reservations_ce_mois']); ?></span>
                                    </div>
                                    <div class="flex items-center justify-between pt-2">
                                        <span class="text-slate-600 dark:text-slate-400 font-medium">Total dépensé</span>
                                        <span class="text-2xl font-bold text-green-600 dark:text-green-400"><?php echo e(number_format($miniStats['client']['total_depense'], 2, ',', ' ')); ?> €</span>
                                    </div>
                                </div>
                                
                                <a href="<?php echo e(route('dashboard')); ?>" class="mt-6 block text-center px-4 py-2 bg-green-600 hover:bg-green-700 dark:bg-green-500 dark:hover:bg-green-600 text-white font-semibold rounded-lg transition">
                                    Voir mes réservations
                                </a>
                            </div>
                        <?php endif; ?>

                        <?php if($user->est_gerant && isset($miniStats['gerant'])): ?>
                            <!-- Section Gérant -->
                            <div class="bg-gradient-to-br from-orange-50 to-orange-100/50 dark:from-orange-900/20 dark:to-orange-800/10 rounded-2xl border border-orange-200 dark:border-orange-800 p-6">
                                ...
                                <div class="space-y-4">
                                    <div class="flex items-center justify-between pb-3 border-b border-orange-200 dark:border-orange-800">
                                        ...
                                        <span class="text-2xl font-bold text-slate-900 dark:text-white"><?php echo e($miniStats['gerant']['total_entreprises']); ?></span>
                                    </div>
                                    <div class="flex items-center justify-between pb-3 border-b border-orange-200 dark:border-orange-800">
                                        <span class="text-slate-600 dark:text-slate-400">Réservations totales</span>
                                        <span class="text-xl font-semibold text-slate-900 dark:text-white"><?php echo e($miniStats['gerant']['total_reservations']); ?></span>
                                    </div>
                                    <div class="flex items-center justify-between pb-3 border-b border-orange-200 dark:border-orange-800">
                                        <span class="text-slate-600 dark:text-slate-400">Réservations ce mois</span>
                                        <span class="text-xl font-semibold text-orange-600 dark:text-orange-400"><?php echo e($miniStats['gerant']['reservations_ce_mois']); ?></span>
                                    </div>
                                    <div class="flex items-center justify-between pb-3 border-b border-orange-200 dark:border-orange-800">
                                        <span class="text-slate-600 dark:text-slate-400">Revenu payé</span>
                                        <span class="text-xl font-semibold text-blue-600 dark:text-blue-400"><?php echo e(number_format($miniStats['gerant']['revenu_paye'], 2, ',', ' ')); ?> €</span>
                                    </div>
                                    <div class="flex items-center justify-between pt-2">
                                        <span class="text-slate-600 dark:text-slate-400 font-medium">Revenu total</span>
                                        <span class="text-2xl font-bold text-orange-600 dark:text-orange-400"><?php echo e(number_format($miniStats['gerant']['revenu_total'], 2, ',', ' ')); ?> €</span>
                                    </div>
                                </div>
                                
                                <a href="<?php echo e(route('dashboard')); ?>" class="mt-6 block text-center px-4 py-2 bg-orange-600 hover:bg-orange-700 dark:bg-orange-500 dark:hover:bg-orange-600 text-white font-semibold rounded-lg transition">
        ...
        <?php else: ?>
            ...
            <section class="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-green-600 to-orange-500">
                <div class="max-w-4xl mx-auto text-center">
                    ...
                    <?php if(Route::has('signup')): ?>
                        <a href="<?php echo e(route('signup')); ?>" class="inline-block px-8 py-4 bg-white text-green-600 font-bold rounded-xl shadow-2xl hover:shadow-3xl transition-all transform hover:-translate-y-1 hover:scale-105">
