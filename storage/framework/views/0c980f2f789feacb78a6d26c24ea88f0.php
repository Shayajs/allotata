...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Dashboard'); ?> - BrightShell ERP</title>
    ...
    <!-- PWA -->
    <link rel="manifest" href="<?php echo e(route('manifest.brightshell')); ?>">
    <meta name="theme-color" content="#0f172a">
    <meta name="apple-mobile-web-app-capable" content="yes">
    <meta name="apple-mobile-web-app-status-bar-style" content="black-translucent">
    <meta name="apple-mobile-web-app-title" content="BrightShell">
    <link rel="apple-touch-icon" href="<?php echo e(asset('media/brightshell/favicon.png')); ?>">
...
<body>
    ...
    <aside class="sidebar" id="sidebar">
        <div class="sidebar-header">
            ...
            ?>
            <?php if($hasLogo): ?>
                <img src="<?php echo e(asset('media/brightshell/logo.png')); ?>" alt="Logo" class="sidebar-logo">
            <?php else: ?>
        ...
        <nav class="sidebar-nav">
            <a href="<?php echo e(route('brightshell.index')); ?>" class="nav-link <?php echo e(request()->routeIs('brightshell.index') ? 'active' : ''); ?>">
                <svg fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2V6zM14 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V6zM4 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2v-2zM14 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z"/></svg>
                Dashboard
            </a>
            
            <div class="nav-section">CRM</div>
            <a href="<?php echo e(route('brightshell.clients')); ?>" class="nav-link <?php echo e(request()->routeIs('brightshell.clients*') ? 'active' : ''); ?>">
                <svg fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z"/></svg>
                Clients
            </a>
            
            <div class="nav-section">Commercial</div>
            <a href="<?php echo e(route('brightshell.devis')); ?>" class="nav-link <?php echo e(request()->routeIs('brightshell.devis*') ? 'active' : ''); ?>">
                <svg fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/></svg>
                Devis
            </a>
            <a href="<?php echo e(route('brightshell.factures')); ?>" class="nav-link <?php echo e(request()->routeIs('brightshell.factures*') ? 'active' : ''); ?>">
                <svg fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 9V7a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2m2 4h10a2 2 0 002-2v-6a2 2 0 00-2-2H9a2 2 0 00-2 2v6a2 2 0 002 2zm7-5a2 2 0 11-4 0 2 2 0 014 0z"/></svg>
                Factures
            </a>
            <a href="<?php echo e(route('brightshell.legals')); ?>" class="nav-link <?php echo e(request()->routeIs('brightshell.legals*') ? 'active' : ''); ?>">
                <svg fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/></svg>
                Legals
            </a>
            
            <div class="nav-section">Gestion</div>
            <a href="<?php echo e(route('brightshell.projets')); ?>" class="nav-link <?php echo e(request()->routeIs('brightshell.projets*') ? 'active' : ''); ?>">
                <svg fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2"/></svg>
                Projets
            </a>
            <a href="<?php echo e(route('brightshell.taches')); ?>" class="nav-link <?php echo e(request()->routeIs('brightshell.taches*') ? 'active' : ''); ?>">
                <svg fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4"/></svg>
                Tâches
            </a>
            <a href="<?php echo e(route('brightshell.notes')); ?>" class="nav-link <?php echo e(request()->routeIs('brightshell.notes*') ? 'active' : ''); ?>">
                <svg fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/></svg>
                Notes
            </a>
            <a href="<?php echo e(route('brightshell.agenda')); ?>" class="nav-link <?php echo e(request()->routeIs('brightshell.agenda*') ? 'active' : ''); ?>">
                <svg fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"/></svg>
                Agenda
            </a>
            <a href="<?php echo e(route('brightshell.documents')); ?>" class="nav-link <?php echo e(request()->routeIs('brightshell.documents*') ? 'active' : ''); ?>">
            ...
            <a href="<?php echo e(route('brightshell.ressources')); ?>" class="nav-link <?php echo e(request()->routeIs('brightshell.ressources*') ? 'active' : ''); ?>">
                <svg fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
                Ressources
            </a>
            <a href="<?php echo e(route('brightshell.comptabilite')); ?>" class="nav-link <?php echo e(request()->routeIs('brightshell.comptabilite*') ? 'active' : ''); ?>">
            ...
            <a href="<?php echo e(route('brightshell.fournisseurs')); ?>" class="nav-link <?php echo e(request()->routeIs('brightshell.fournisseurs*') ? 'active' : ''); ?>">
                <svg fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"/></svg>
                Fournisseurs
            </a>
            <a href="<?php echo e(route('brightshell.statistiques')); ?>" class="nav-link <?php echo e(request()->routeIs('brightshell.statistiques*') ? 'active' : ''); ?>">
                <svg fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"/></svg>
                Statistiques
            </a>
            <a href="<?php echo e(route('brightshell.exports')); ?>" class="nav-link <?php echo e(request()->routeIs('brightshell.exports*') ? 'active' : ''); ?>">
                <svg fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4"/></svg>
                Exports
            </a>
            
            <div class="nav-section">Communication</div>
            <a href="<?php echo e(route('brightshell.mailing')); ?>" class="nav-link <?php echo e(request()->routeIs('brightshell.mailing*') ? 'active' : ''); ?>">
                <svg fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/></svg>
                Mailing
            </a>
            
            <div class="nav-section">Système</div>
            <a href="<?php echo e(route('brightshell.settings')); ?>" class="nav-link <?php echo e(request()->routeIs('brightshell.settings') ? 'active' : ''); ?>">
            ...
            <a href="<?php echo e(route('brightshell.installer')); ?>" class="nav-link <?php echo e(request()->routeIs('brightshell.installer') ? 'active' : ''); ?>">
                <svg fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4"/></svg>
                Installer
            </a>
            <a href="<?php echo e(route('admin.index')); ?>" class="nav-link" style="opacity: 0.6;">
...
<?php /**PATH /var/www/html/resources/views/brightshell/layout.blade.php ENDPATH**/ ?>