...
<head>
    ...
    <title>Services - <?php echo e($entreprise->nom); ?></title>
...
<body class="bg-slate-50 dark:bg-slate-900 text-slate-900 dark:text-slate-100 antialiased transition-colors duration-200">
        ...
        <nav class="bg-white dark:bg-slate-800 border-b border-slate-200 dark:border-slate-700 sticky top-0 z-50">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
                <div class="flex items-center justify-between">
                    <a href="<?php echo e(route('public.entreprise', $entreprise->slug)); ?>" class="inline-flex items-center gap-2 text-slate-600 dark:text-slate-400 hover:text-green-600 dark:hover:text-green-400 transition">
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
                <div class="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg p-4">
                    <?php $__currentLoopData = $errors->all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $error): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <p class="text-red-800 dark:text-red-300"><?php echo e($error); ?></p>
        ...
        <?php if($typesServices && $typesServices->count() > 0): ?>
            ...
            <div class="lg:hidden">
                ...
                <div id="mobile-content-liste" class="p-4 space-y-4">
                    ...
                    ?>
                    <?php $__currentLoopData = $servicesPrincipaux; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php
                        ...
                        <div 
                            ...
                            onclick="selectService(<?php echo e($service->id); ?>, true)"
                        ...
                        >
                            ...
                            <div class="p-4">
                                <div class="flex items-center justify-between mb-2">
                                    <h3 class="text-lg font-bold text-slate-900 dark:text-white"><?php echo e($service->nom); ?></h3>
                    ...
                    <?php if($servicesRestants->count() > 0): ?>
                        ...
                        <div class="bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 overflow-hidden">
                            ...
                            >
                                <span class="font-semibold">Voir <?php echo e($servicesRestants->count()); ?> autre(s) service(s)</span>
                            ...
                            <div id="services-restants-list" class="hidden space-y-4 p-4 border-t border-slate-200 dark:border-slate-700">
                                <?php $__currentLoopData = $servicesRestants; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php
                                        $imageCouverture = $service->imageCouverture;
                                        $premiereImage = $service->images->first();
                                        $imageAffichee = $imageCouverture ? $imageCouverture : $premiereImage;
            ...
            <div class="hidden lg:flex max-w-[1920px] mx-auto h-[calc(100vh-73px)]">
                ...
                <div class="w-1/5 border-r border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 overflow-y-auto">
                    <div class="p-4 space-y-4">
                        ...
                        ?>
                        <?php $__currentLoopData = $servicesPrincipauxDesktop; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php
                                $imageCouverture = $service->imageCouverture;
                                $premiereImage = $service->images->first();
                                $imageAffichee = $imageCouverture ? $imageCouverture : $premiereImage;
                            ?>
                            <div 
                                class="service-card bg-white dark:bg-slate-800 rounded-xl border-2 border-slate-200 dark:border-slate-700 p-4 cursor-pointer hover:border-green-500 dark:hover:border-green-600 hover:shadow-lg transition-all <?php echo e($loop->first ? 'border-green-500 dark:border-green-600 shadow-md' : ''); ?>"
                                onclick="selectService(<?php echo e($service->id); ?>, false)"
                                data-service-id="<?php echo e($service->id); ?>"
                            >
                                <?php if($imageAffichee): ?>
                                ...
                                <?php endif; ?>
                                <div class="flex items-center justify-between mb-2">
                                    <h3 class="text-base font-bold text-slate-900 dark:text-white line-clamp-2"><?php echo e($service->nom); ?></h3>
                                    <?php if($service->options->count() > 0): ?>
                        ...
                        <?php if($servicesRestantsDesktop->count() > 0): ?>
                            ...
                            <div class="bg-white dark:bg-slate-800 rounded-xl border-2 border-slate-200 dark:border-slate-700 overflow-hidden">
                                <button 
                                    ...
                                    class="w-full px-4 py-3 flex items-center justify-between text-slate-900 dark:text-white hover:bg-slate-50 dark:hover:bg-slate-700 transition"
                                >
                                    <span class="font-semibold text-sm">Voir <?php echo e($servicesRestantsDesktop->count()); ?> autre(s)</span>
                                ...
                                <div id="services-restants-desktop-list" class="hidden space-y-4 p-4 border-t border-slate-200 dark:border-slate-700">
                                    <?php $__currentLoopData = $servicesRestantsDesktop; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php
                                            $imageCouverture = $service->imageCouverture;
                                            $premiereImage = $service->images->first();
                                            $imageAffichee = $imageCouverture ? $imageCouverture : $premiereImage;
                ...
                <div class="flex-1 overflow-y-auto bg-slate-50 dark:bg-slate-900">
                    <div id="service-details" class="p-8">
                        ...
                        <div class="max-w-4xl mx-auto">
                            <!-- Carousel d'images -->
                            <?php if($firstService->images->count() > 0): ?>
                                <div class="relative mb-6 group" id="service-image-carousel-container">
                                    <div class="relative h-96 w-full rounded-2xl overflow-hidden shadow-xl bg-slate-200 dark:bg-slate-700">
                                        ...
                                        <div class="relative w-full h-full" id="service-carousel-wrapper">
                                            <?php $__currentLoopData = $firstService->images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <img 
                                                    src="<?php echo e(asset('media/' . $image->image_path)); ?>" 
                                                    alt="<?php echo e($firstService->nom); ?>"
                                                    class="service-carousel-image w-full h-full object-cover transition-opacity duration-500 <?php echo e($index === 0 ? 'opacity-100' : 'opacity-0 absolute inset-0'); ?>"
                                                    data-index="<?php echo e($index); ?>"
                                                    onclick="openLightboxService(<?php echo e($index); ?>)"
                                                    style="cursor: <?php echo e($firstService->images->count() > 1 ? 'zoom-in' : 'default'); ?>"
                                                >
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </div>

                                        <!-- Badge nombre d'images (si plusieurs) -->
                                        <?php if($firstService->images->count() > 1): ?>
                                            <div class="absolute top-4 left-4 bg-black/70 backdrop-blur-sm text-white px-3 py-1.5 rounded-full text-sm font-semibold flex items-center gap-2 z-10">
                                                ...
                                                <span id="service-image-counter">1 / <?php echo e($firstService->images->count()); ?></span>
                                            </div>
                                        <?php endif; ?>
                                        ...
                                        <?php if($firstService->images->count() > 1): ?>
                                            ...
                                            <div class="absolute bottom-4 left-1/2 -translate-x-1/2 flex gap-2 z-10">
                                                <?php $__currentLoopData = $firstService->images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <button 
                                                        onclick="goToImageService(<?php echo e($index); ?>)"
                                                        class="service-carousel-dot w-2 h-2 rounded-full transition-all <?php echo e($index === 0 ? 'bg-white w-6' : 'bg-white/50 hover:bg-white/75'); ?>"
                                                        aria-label="Image <?php echo e($index + 1); ?>"
                                                    ></button>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </div>
                                        <?php endif; ?>
                                    ...
                                    <?php if($firstService->images->count() > 1): ?>
                                        <div class="mt-4 flex gap-2 overflow-x-auto pb-2" id="service-thumbnails" style="scrollbar-width: thin; scrollbar-color: rgba(148, 163, 184, 0.3) transparent;">
                                            <?php $__currentLoopData = $firstService->images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <button 
                                                    onclick="goToImageService(<?php echo e($index); ?>)"
                                                    class="service-thumbnail flex-shrink-0 w-20 h-20 rounded-lg overflow-hidden border-2 transition-all <?php echo e($index === 0 ? 'border-green-500 ring-2 ring-green-500' : 'border-slate-200 dark:border-slate-600 hover:border-green-400'); ?>"
                                                    data-index="<?php echo e($index); ?>"
                                                >
                                                    <img 
                                                        src="<?php echo e(asset('media/' . $image->image_path)); ?>" 
                            ...
                            <!-- Titre et prix -->
                            <div class="mb-6">
                                <h1 class="text-4xl font-bold text-slate-900 dark:text-white mb-4" id="service-title"><?php echo e($firstService->nom); ?></h1>
                            ...
                            <div class="mb-8">
                                ...
                                <p class="text-slate-700 dark:text-slate-300 text-lg leading-relaxed" id="service-description">
                                    <?php echo e($firstService->description ?: 'Aucune description disponible.'); ?>
                            ...
                            <?php if($photosAvis->count() > 0): ?>
                                <div class="mb-8">
                                    ...
                                    <div class="grid grid-cols-2 md:grid-cols-4 gap-4" id="service-avis-photos">
                                        <?php $__currentLoopData = $photosAvis->take(8); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $photo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <?php if($entreprise->realisationPhotos->count() > 0): ?>
                                <div class="mb-8">
                                    ...
                                    <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                                        <?php $__currentLoopData = $entreprise->realisationPhotos->take(8); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $photo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="relative h-32 rounded-lg overflow-hidden">
                                                <img 
                                                    src="<?php echo e(asset('storage/' . $photo->photo_path)); ?>" 
                            ...
                            <div class="mb-8">
                                <h2 class="text-2xl font-bold text-slate-900 dark:text-white mb-4">
                                    ...
                                    <span class="text-lg font-normal text-slate-600 dark:text-slate-400">
                                        (<?php echo e($firstService->nombre_avis); ?> avis, note moyenne: <?php echo e($firstService->note_moyenne); ?>/5)
                                    </span>
                                </h2>
                                ...
                                <?php if(auth()->guard()->check()): ?>
                                    <?php if(!$userAvis): ?>
                                        <div class="mb-6 bg-slate-50 dark:bg-slate-800 rounded-lg p-4 border border-slate-200 dark:border-slate-700">
                                            ...
                                            <form action="<?php echo e(route('public.service.avis.store', ['slug' => $entreprise->slug, 'serviceId' => $firstService->id])); ?>" method="POST">
                                                <?php echo csrf_field(); ?>
                                                <div class="mb-4">
                                                    ...
                                                    <div class="flex gap-2" id="note-stars-service">
                                                        <?php for($i = 1; $i <= 5; $i++): ?>
                                                            <button type="button" onclick="setNoteService(<?php echo e($i); ?>)" class="star-btn-service text-3xl text-slate-300 dark:text-slate-600 hover:text-yellow-400 transition-colors" data-note="<?php echo e($i); ?>">☆</button>
                                                        <?php endfor; ?>
                                                    </div>
                                                ...
                                                <?php if($userReservationsPayees->count() > 0): ?>
                                                    <div class="mb-4">
                                                        ...
                                                        <select name="reservation_id" class="w-full px-4 py-2 border border-slate-300 dark:border-slate-600 rounded-lg bg-white dark:bg-slate-700 text-slate-900 dark:text-white">
                                                            ...
                                                            <?php $__currentLoopData = $userReservationsPayees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $reservation): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <option value="<?php echo e($reservation->id); ?>">Réservation du <?php echo e($reservation->date_reservation->format('d/m/Y')); ?> - <?php echo e(number_format($reservation->prix, 2, ',', ' ')); ?> €</option>
                                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                        </select>
                                                    </div>
                                                <?php endif; ?>
                                ...
                                <?php else: ?>
                                    <div class="mb-6 bg-blue-50 dark:bg-blue-900/20 rounded-lg p-4 border border-blue-200 dark:border-blue-800">
                                        <p class="text-sm text-blue-800 dark:text-blue-300">
                                            <a href="<?php echo e(route('login')); ?>" class="font-semibold underline">Connectez-vous</a> pour laisser un avis
                                        </p>
                                    </div>
                                <?php endif; ?>

                                <?php if($avisTries->count() > 0): ?>
                                    <div class="space-y-4" id="service-avis-list">
                                        <?php $__currentLoopData = $avisTries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $avis): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="bg-white dark:bg-slate-800 rounded-lg p-4 border border-slate-200 dark:border-slate-700 <?php echo e($avis->aPaiementConfirme() ? 'ring-2 ring-green-500 dark:ring-green-600' : ''); ?>">
                                                    ...
                                                    <div class="flex items-center gap-3">
                                                        <div class="w-10 h-10 rounded-full bg-slate-200 dark:bg-slate-700 flex items-center justify-center">
                                                            <span class="text-slate-600 dark:text-slate-400 font-semibold">
                                                                <?php echo e(substr($avis->user->name ?? 'A', 0, 1)); ?>

                                                            </span>
                                                        </div>
                                                        <div>
                                                            <div class="flex items-center gap-2">
                                                                <p class="font-semibold text-slate-900 dark:text-white"><?php echo e($avis->user->name ?? 'Utilisateur'); ?></p>
                                                                <?php if($avis->aPaiementConfirme()): ?>
                                                            ...
                                                            <p class="text-xs text-slate-500 dark:text-slate-400"><?php echo e($avis->created_at->format('d/m/Y')); ?></p>
                                                        </div>
                                                    </div>
                                                    <div class="flex items-center gap-1">
                                                        <?php for($i = 1; $i <= 5; $i++): ?>
                                                            <span class="text-yellow-400 <?php echo e($i <= $avis->note ? '' : 'opacity-30'); ?>">★</span>
                                                        <?php endfor; ?>
                                                    </div>
                                                </div>
                                                <?php if($avis->commentaire): ?>
                                                    <p class="text-slate-700 dark:text-slate-300 mt-2"><?php echo e($avis->commentaire); ?></p>
                                                <?php endif; ?>
                                            </div>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </div>
                            ...
                            <div class="mt-8">
                                <a 
                                    ...
                                    href="<?php echo e(route('public.agenda', ['slug' => $entreprise->slug, 'service' => $firstService->id])); ?>"
    ...
    <script>
        ...
        const servicesData = <?php echo json_encode($servicesDataArray, 15, 512) ?>;

        const realisationPhotos = <?php echo json_encode($realisationPhotosArray, 15, 512) ?>;
        const agendaBaseUrl = <?php echo json_encode($agendaBaseUrl, 15, 512) ?>;
        ...
        <div class="relative w-full h-full flex items-center justify-center p-4" onclick="event.stopPropagation()">
            ...
            <?php if($firstService->images->count() > 1): ?>
                ...
                <div class="absolute bottom-4 left-1/2 -translate-x-1/2 bg-black/70 backdrop-blur-sm text-white px-4 py-2 rounded-full text-sm font-semibold z-10">
                    <span id="service-lightbox-counter">1 / <?php echo e($firstService->images->count()); ?></span>
                </div>
            <?php endif; ?>
...
<?php /**PATH /var/www/html/resources/views/public/services.blade.php ENDPATH**/ ?>