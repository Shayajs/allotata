                    ...
                    <div id="tab-confidentialite" class="tab-content hidden">
                        ...
                        <div class="space-y-6">
                            ...
                            <div class="p-6 border border-slate-200 dark:border-slate-700 rounded-lg bg-slate-50 dark:bg-slate-800/50">
                                ...
                                <?php if(isset($gdprData['pendingExport']) && $gdprData['pendingExport']): ?>
                                ...
                                <?php if(isset($gdprData['lastExport']) && $gdprData['lastExport'] && $gdprData['lastExport']->isDownloadAvailable()): ?>
                                        ...
                                        <div class="flex items-center justify-between">
                                            <div>
                                                ...
                                                <p class="text-xs text-green-600 dark:text-green-500 mt-1">
                                                    Généré le <?php echo e($gdprData['lastExport']->processed_at->format('d/m/Y à H:i')); ?> 
                                                    — Expire le <?php echo e($gdprData['lastExport']->expires_at->format('d/m/Y')); ?>

                                                    <?php if($gdprData['lastExport']->metadata && isset($gdprData['lastExport']->metadata['file_size'])): ?>
                                                        — <?php echo e(number_format($gdprData['lastExport']->metadata['file_size'] / 1024, 0)); ?> Ko
                                                    <?php endif; ?>
                                                </p>
                                            </div>
                                            <a href="<?php echo e(route('gdpr.download', $gdprData['lastExport'])); ?>" class="px-4 py-2 bg-green-600 hover:bg-green-700 text-white text-sm font-medium rounded-lg transition">
                                                Télécharger
                                            </a>
                                        </div>
                                    </div>
                                ...
                                <form action="<?php echo e(route('gdpr.export')); ?>" method="POST">
                                    <?php echo csrf_field(); ?>
                            ...
                            <div class="p-6 border border-red-200 dark:border-red-800 rounded-lg bg-red-50/50 dark:bg-red-900/10">
                                ...
                                <?php if(isset($gdprData['pendingDeletion']) && $gdprData['pendingDeletion']): ?>
                                        ...
                                        <div class="flex items-start gap-3">
                                            ...
                                            <div class="flex-1">
                                                ...
                                                <p class="text-sm text-red-700 dark:text-red-400 mt-1">
                                                    Votre compte sera définitivement supprimé le <strong><?php echo e($gdprData['pendingDeletion']->scheduled_at->format('d/m/Y')); ?></strong>
                                                    (dans <?php echo e($gdprData['pendingDeletion']->daysUntilExecution()); ?> jour(s)).
                                                </p>
                                                <?php if($gdprData['pendingDeletion']->reason): ?>
                                                    <p class="text-xs text-red-600 dark:text-red-500 mt-1">Raison : <?php echo e($gdprData['pendingDeletion']->reason); ?></p>
                                                <?php endif; ?>
                                            </div>
                                        </div>
                                        <form action="<?php echo e(route('gdpr.cancel-deletion', $gdprData['pendingDeletion'])); ?>" method="POST" class="mt-4">
                                            <?php echo csrf_field(); ?>
                                ...
                                <?php else: ?>
                                    ...
                                    <form action="<?php echo e(route('gdpr.request-deletion')); ?>" method="POST" id="deletion-form" class="space-y-4">
                                        <?php echo csrf_field(); ?>
                                        <div>
                            ...
                            <?php if(isset($gdprData['history']) && $gdprData['history']->count() > 0): ?>
                                <div class="p-6 border border-slate-200 dark:border-slate-700 rounded-lg bg-slate-50 dark:bg-slate-800/50">
                                    ...
                                    <div class="overflow-x-auto">
                                        <table class="w-full text-sm text-left">
                                            ...
                                            <tbody class="divide-y divide-slate-200 dark:divide-slate-700">
                                                <?php $__currentLoopData = $gdprData['history']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $req): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <tr>
                                                        <td class="py-2 pr-4">
                                                            <span class="inline-flex items-center px-2 py-0.5 rounded text-xs font-medium <?php echo e($req->isExport() ? 'bg-blue-100 dark:bg-blue-900/30 text-blue-800 dark:text-blue-400' : 'bg-red-100 dark:bg-red-900/30 text-red-800 dark:text-red-400'); ?>">
                                                                <?php echo e($req->type_label); ?>
                                                        ...
                                                        <td class="py-2 pr-4">
                                                            ...
                                                            ?>
                                                            <span class="inline-flex items-center px-2 py-0.5 rounded text-xs font-medium <?php echo e($statusColors[$req->status] ?? ''); ?>">
                                                                <?php echo e($req->status_label); ?>
                                                        ...
                                                        <td class="py-2">
                                                            <?php if($req->isDownloadAvailable()): ?>
                                                                <a href="<?php echo e(route('gdpr.download', $req)); ?>" class="text-green-600 dark:text-green-400 hover:underline text-xs font-medium">
                                                                    Télécharger
                                                                </a>
                                                            <?php elseif($req->isDeletion() && $req->canBeCancelled()): ?>
                                                                <form action="<?php echo e(route('gdpr.cancel-deletion', $req)); ?>" method="POST" class="inline">
                                                                    <?php echo csrf_field(); ?>
