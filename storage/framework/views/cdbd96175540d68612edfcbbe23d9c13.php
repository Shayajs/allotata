...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>" class="scroll-smooth">
    <head>
        ...
        <title><?php echo e($entreprise->nom); ?> - Dashboard - Allo Tata</title>
        <?php echo $__env->make('partials.favicon', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        
        <!-- PWA / Manifest Dynamique -->
        <link rel="manifest" href="<?php echo e(route('manifest.show', $entreprise->slug)); ?>">
        <meta name="theme-color" content="#0f172a">
        <meta name="apple-mobile-web-app-capable" content="yes">
        <meta name="apple-mobile-web-app-status-bar-style" content="black-translucent">
        <meta name="apple-mobile-web-app-title" content="<?php echo e($entreprise->nom); ?>">
        <link rel="apple-touch-icon" href="<?php echo e(route('manifest.icon', ['slug' => $entreprise->slug, 'size' => 192])); ?>">
    ...
    <body class="bg-slate-50 dark:bg-slate-900 text-slate-900 dark:text-slate-100 antialiased transition-colors duration-200 min-h-screen flex flex-col">
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex items-center justify-between h-16">
                    <div class="flex items-center gap-2 sm:gap-4">
                        <a href="<?php echo e(route('dashboard')); ?>" class="text-xl sm:text-2xl font-bold bg-gradient-to-r from-green-500 to-orange-500 bg-clip-text text-transparent">
                            Allo Tata
                        </a>
                        
                        <!-- Menu Burger pour mobile web -->
                        <?php echo $__env->make('components.mobile-nav', ['navType' => 'entreprise', 'entreprise' => $entreprise, 'aGestionMultiPersonnes' => $aGestionMultiPersonnes ?? false, 'activeTab' => $activeTab ?? 'accueil'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                        ...
                        <div class="relative hidden md:block">
                            ...
                            >
                                <?php if($entreprise->logo): ?>
                                    <img src="<?php echo e(asset('media/' . $entreprise->logo)); ?>" alt="" class="w-6 h-6 rounded object-cover">
                                <?php else: ?>
                                ...
                                <?php endif; ?>
                                <span class="font-medium text-slate-900 dark:text-white max-w-32 truncate"><?php echo e($entreprise->nom); ?></span>
                            ...
                            <div id="entreprise-selector" class="hidden absolute left-0 mt-2 w-64 bg-white dark:bg-slate-800 rounded-lg shadow-xl border border-slate-200 dark:border-slate-700 py-2 z-50">
                                ...
                                <a href="<?php echo e(route('entreprise.dashboard', $entreprise->slug)); ?>" class="flex items-center gap-3 px-3 py-2 bg-green-50 dark:bg-green-900/20 text-green-700 dark:text-green-400">
                                    <?php if($entreprise->logo): ?>
                                        <img src="<?php echo e(asset('media/' . $entreprise->logo)); ?>" alt="" class="w-8 h-8 rounded object-cover">
                                    <?php else: ?>
                                    ...
                                    <div class="flex-1 min-w-0">
                                        <p class="font-medium truncate"><?php echo e($entreprise->nom); ?></p>
                                        <p class="text-xs text-green-600 dark:text-green-500">Entreprise actuelle</p>
                                    </div>
                                </a>
                                <?php $__currentLoopData = $autresEntreprises; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $autre): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <a href="<?php echo e(route('entreprise.dashboard', $autre->slug)); ?>" class="flex items-center gap-3 px-3 py-2 hover:bg-slate-50 dark:hover:bg-slate-700 text-slate-900 dark:text-white transition">
                                        <?php if($autre->logo): ?>
                                            <img src="<?php echo e(asset('media/' . $autre->logo)); ?>" alt="" class="w-8 h-8 rounded object-cover">
                                        <?php else: ?>
                                            <div class="w-8 h-8 rounded bg-gradient-to-r from-green-500 to-orange-500 flex items-center justify-center text-white text-sm font-bold">
                                                <?php echo e(strtoupper(substr($autre->nom, 0, 1))); ?>

                                            </div>
                                        <?php endif; ?>
                                        <div class="flex-1 min-w-0">
                                            <p class="font-medium truncate"><?php echo e($autre->nom); ?></p>
                                            <p class="text-xs text-slate-500 dark:text-slate-400"><?php echo e($autre->type_activite); ?></p>
                                        </div>
                                    </a>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                <div class="border-t border-slate-200 dark:border-slate-700 mt-2 pt-2">
                                    <a href="<?php echo e(route('entreprise.create')); ?>" class="flex items-center gap-2 px-3 py-2 text-green-600 dark:text-green-400 hover:bg-slate-50 dark:hover:bg-slate-700 transition">
                    ...
                    <div class="flex items-center gap-2 sm:gap-3 desktop-nav-links">
                        <a href="<?php echo e(route('public.entreprise', $entreprise->slug)); ?>" target="_blank" class="hidden lg:flex items-center px-3 py-2 text-sm font-medium text-slate-600 dark:text-slate-400 hover:text-green-600 dark:hover:text-green-400 transition touch-target">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14"></path>
                            </svg>
                            <span class="hidden xl:inline ml-1">Page publique</span>
                        </a>
                        <a href="<?php echo e(route('tickets.create')); ?>" class="hidden lg:inline-flex items-center px-3 py-2 text-sm font-medium bg-purple-100 dark:bg-purple-900/30 hover:bg-purple-200 dark:hover:bg-purple-900/50 text-purple-800 dark:text-purple-400 rounded-lg transition touch-target">
                            <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 5v2m0 4v2m0 4v2M5 5a2 2 0 00-2 2v3a2 2 0 110 4v3a2 2 0 002 2h14a2 2 0 002-2v-3a2 2 0 110-4V7a2 2 0 00-2-2H5z"></path>
                            </svg>
                            <span class="hidden xl:inline ml-1">Support</span>
                        </a>
                        <a href="<?php echo e(route('dashboard')); ?>" class="hidden xl:inline-flex items-center px-3 py-2 text-sm font-medium text-slate-600 dark:text-slate-400 hover:text-green-600 dark:hover:text-green-400 transition touch-target">
                            Mon compte
                        </a>
                        <span class="hidden xl:inline text-sm text-slate-500 dark:text-slate-400"><?php echo e($user->name); ?></span>
                        <form method="POST" action="<?php echo e(route('logout')); ?>" class="hidden xl:inline">
                            <?php echo csrf_field(); ?>
        ...
        <div class="max-w-7xl 2xl:max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-6 main-content flex-1 w-full">
            ...
            <div class="bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-slate-200 dark:border-slate-700 p-4 sm:p-6 mb-4 sm:mb-6">
                <div class="flex items-center gap-3 sm:gap-4">
                    <?php if($entreprise->logo): ?>
                        <img src="<?php echo e(asset('media/' . $entreprise->logo)); ?>" alt="<?php echo e($entreprise->nom); ?>" class="w-16 h-16 rounded-xl object-cover border-2 border-slate-200 dark:border-slate-700">
                    <?php else: ?>
                    ...
                    <div class="flex-1 min-w-0">
                        <div class="flex flex-wrap items-center gap-2 sm:gap-3">
                            <h1 class="text-xl sm:text-2xl font-bold text-slate-900 dark:text-white truncate"><?php echo e($entreprise->nom); ?></h1>
                        ...
                        <p class="text-slate-600 dark:text-slate-400"><?php echo e($entreprise->type_activite); ?> <?php if($entreprise->ville): ?> • <?php echo e($entreprise->ville); ?> <?php endif; ?></p>
                    </div>
                    <div class="flex items-center gap-2">
                        <?php if($stats['nombre_avis'] > 0): ?>
                            <div class="text-right">
                                <div class="flex items-center gap-1 text-yellow-500">
                                    <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                                        <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"></path>
                                    </svg>
                                    <span class="font-bold"><?php echo e($stats['note_moyenne']); ?></span>
                                </div>
                                <p class="text-xs text-slate-500 dark:text-slate-400"><?php echo e($stats['nombre_avis']); ?> avis</p>
                            </div>
                        <?php endif; ?>
                    </div>
                </div>
                ...
                <aside class="hidden md:flex flex-col w-16 xl:w-64 flex-shrink-0 sticky top-20 self-start h-[calc(100vh-6rem)] overflow-y-auto">
                    <nav class="bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-slate-200 dark:border-slate-700 p-2 xl:p-3 space-y-1">
                        ...
                        <button 
                            ...
                            class="sidebar-tab w-full flex items-center justify-center xl:justify-start gap-3 px-3 py-3 rounded-lg text-sm font-medium transition-all group relative <?php echo e($activeTab === 'accueil' ? 'bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-400' : 'text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-700 hover:text-slate-900 dark:hover:text-white'); ?>"
                            data-tab="accueil"
                        >
                            <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <?php if($stats['reservations_en_attente'] > 0): ?>
                                <span class="xl:ml-auto px-2 py-0.5 text-xs bg-yellow-500 text-white rounded-full"><?php echo e($stats['reservations_en_attente']); ?></span>
                            <?php endif; ?>
                            <!-- Tooltip for tablet -->
                        ...
                        <button 
                            ...
                            class="sidebar-tab w-full flex items-center justify-center xl:justify-start gap-3 px-3 py-3 rounded-lg text-sm font-medium transition-all group relative <?php echo e($activeTab === 'agenda' ? 'bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-400' : 'text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-700 hover:text-slate-900 dark:hover:text-white'); ?>"
                            data-tab="agenda"
                        >
                            <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <button 
                            ...
                            class="sidebar-tab w-full flex items-center justify-center xl:justify-start gap-3 px-3 py-3 rounded-lg text-sm font-medium transition-all group relative <?php echo e($activeTab === 'services' ? 'bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-400' : 'text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-700 hover:text-slate-900 dark:hover:text-white'); ?>"
                        ...
                        <button 
                            ...
                            class="sidebar-tab w-full flex items-center justify-center xl:justify-start gap-3 px-3 py-3 rounded-lg text-sm font-medium transition-all group relative <?php echo e($activeTab === 'stock' ? 'bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-400' : 'text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-700 hover:text-slate-900 dark:hover:text-white'); ?>"
                            data-tab="stock"
                        >
                            <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <button 
                            ...
                            class="sidebar-tab w-full flex items-center justify-center xl:justify-start gap-3 px-3 py-3 rounded-lg text-sm font-medium transition-all group relative <?php echo e($activeTab === 'commandes' ? 'bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-400' : 'text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-700 hover:text-slate-900 dark:hover:text-white'); ?>"
                            data-tab="commandes"
                        >
                            <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <?php if(isset($commandesEnAttente) && $commandesEnAttente > 0): ?>
                                <span class="ml-auto px-2 py-0.5 text-xs font-bold bg-red-500 text-white rounded-full"><?php echo e($commandesEnAttente); ?></span>
                            <?php endif; ?>
                        </button>
                        ...
                        <button 
                            ...
                            class="sidebar-tab w-full flex items-center justify-center xl:justify-start gap-3 px-3 py-3 rounded-lg text-sm font-medium transition-all group relative <?php echo e($activeTab === 'equipe' ? 'bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-400' : 'text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-700 hover:text-slate-900 dark:hover:text-white'); ?>"
                            data-tab="equipe"
                        >
                            <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <button 
                            ...
                            class="sidebar-tab w-full flex items-center justify-center xl:justify-start gap-3 px-3 py-3 rounded-lg text-sm font-medium transition-all group relative <?php echo e($activeTab === 'reservations' ? 'bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-400' : 'text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-700 hover:text-slate-900 dark:hover:text-white'); ?>"
                        ...
                        <button 
                            ...
                            class="sidebar-tab w-full flex items-center justify-center xl:justify-start gap-3 px-3 py-3 rounded-lg text-sm font-medium transition-all group relative <?php echo e($activeTab === 'factures' ? 'bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-400' : 'text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-700 hover:text-slate-900 dark:hover:text-white'); ?>"
                            data-tab="factures"
                        >
                            <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <button 
                            ...
                            class="sidebar-tab w-full flex items-center justify-center xl:justify-start gap-3 px-3 py-3 rounded-lg text-sm font-medium transition-all group relative <?php echo e($activeTab === 'finances' ? 'bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-400' : 'text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-700 hover:text-slate-900 dark:hover:text-white'); ?>"
                            data-tab="finances"
                        >
                            <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <button 
                            ...
                            class="sidebar-tab w-full flex items-center justify-center xl:justify-start gap-3 px-3 py-3 rounded-lg text-sm font-medium transition-all group relative <?php echo e($activeTab === 'statistiques' ? 'bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-400' : 'text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-700 hover:text-slate-900 dark:hover:text-white'); ?>"
                        ...
                        <button 
                            ...
                            class="sidebar-tab w-full flex items-center justify-center xl:justify-start gap-3 px-3 py-3 rounded-lg text-sm font-medium transition-all group relative <?php echo e($activeTab === 'outils' ? 'bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-400' : 'text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-700 hover:text-slate-900 dark:hover:text-white'); ?>"
                            data-tab="outils"
                        >
                            <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <button 
                            ...
                            class="sidebar-tab w-full flex items-center justify-center xl:justify-start gap-3 px-3 py-3 rounded-lg text-sm font-medium transition-all group relative <?php echo e($activeTab === 'messagerie' ? 'bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-400' : 'text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-700 hover:text-slate-900 dark:hover:text-white'); ?>"
                            data-tab="messagerie"
                        >
                            <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <?php if($messagesNonLus > 0): ?>
                                <span class="xl:ml-auto px-2 py-0.5 text-xs bg-green-500 text-white rounded-full"><?php echo e($messagesNonLus); ?></span>
                            <?php endif; ?>
                        ...
                        <button 
                            ...
                            class="sidebar-tab w-full flex items-center justify-center xl:justify-start gap-3 px-3 py-3 rounded-lg text-sm font-medium transition-all group relative <?php echo e($activeTab === 'fidelisation' ? 'bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-400' : 'text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-700 hover:text-slate-900 dark:hover:text-white'); ?>"
                        ...
                        <button 
                            ...
                            class="sidebar-tab w-full flex items-center justify-center xl:justify-start gap-3 px-3 py-3 rounded-lg text-sm font-medium transition-all group relative <?php echo e($activeTab === 'abonnements' ? 'bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-400' : 'text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-700 hover:text-slate-900 dark:hover:text-white'); ?>"
                        ...
                        <button 
                            ...
                            class="sidebar-tab w-full flex items-center justify-center xl:justify-start gap-3 px-3 py-3 rounded-lg text-sm font-medium transition-all group relative <?php echo e($activeTab === 'parametres' ? 'bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-400' : 'text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-700 hover:text-slate-900 dark:hover:text-white'); ?>"
                            data-tab="parametres"
                        >
                            <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <button 
                            ...
                            class="sidebar-tab w-full flex items-center justify-center xl:justify-start gap-3 px-3 py-3 rounded-lg text-sm font-medium transition-all group relative <?php echo e($activeTab === 'installer' ? 'bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-400' : 'text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-700 hover:text-slate-900 dark:hover:text-white'); ?>"
                            data-tab="installer"
                        >
                            <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <main class="flex-1 min-w-0">
                    <div class="bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-slate-200 dark:border-slate-700 p-4 sm:p-6">
                        ...
                        <div id="tab-accueil" class="tab-content <?php echo e($activeTab !== 'accueil' ? 'hidden' : ''); ?>">
                            <?php echo $__env->make('entreprise.dashboard.tabs.accueil', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                        </div>

                        <!-- Onglet Agenda -->
                        <div id="tab-agenda" class="tab-content <?php echo e($activeTab !== 'agenda' ? 'hidden' : ''); ?>">
                            <?php echo $__env->make('entreprise.dashboard.tabs.agenda', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                        </div>

                        <!-- Onglet Équipe (multi-personnes) -->
                        <?php if($aGestionMultiPersonnes): ?>
                            <div id="tab-equipe" class="tab-content <?php echo e($activeTab !== 'equipe' ? 'hidden' : ''); ?>">
                                <?php echo $__env->make('entreprise.dashboard.tabs.equipe', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                            </div>
                        <?php endif; ?>

                        <!-- Onglet Réservations -->
                        <div id="tab-reservations" class="tab-content <?php echo e($activeTab !== 'reservations' ? 'hidden' : ''); ?>">
                            <?php echo $__env->make('entreprise.dashboard.tabs.reservations', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                        </div>

                        <!-- Onglet Factures -->
                        <div id="tab-factures" class="tab-content <?php echo e($activeTab !== 'factures' ? 'hidden' : ''); ?>">
                            <?php echo $__env->make('entreprise.dashboard.tabs.factures', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                        </div>

                        <!-- Onglet Finances (Recettes) -->
                        <div id="tab-finances" class="tab-content <?php echo e($activeTab !== 'finances' ? 'hidden' : ''); ?>">
                            <?php echo $__env->make('entreprise.dashboard.tabs.finances', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                        </div>

                        <!-- Onglet Statistiques -->
                        <div id="tab-statistiques" class="tab-content <?php echo e($activeTab !== 'statistiques' ? 'hidden' : ''); ?>">
                            <?php echo $__env->make('entreprise.dashboard.tabs.statistiques', [
                        ...
                        <!-- Onglet Outils -->
                        <div id="tab-outils" class="tab-content <?php echo e($activeTab !== 'outils' ? 'hidden' : ''); ?>">
                            <?php echo $__env->make('entreprise.dashboard.tabs.outils', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                        </div>

                        <!-- Onglet Messagerie -->
                        <div id="tab-messagerie" class="tab-content <?php echo e($activeTab !== 'messagerie' ? 'hidden' : ''); ?>">
                            <?php echo $__env->make('entreprise.dashboard.tabs.messagerie-liste', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                        </div>

                        <!-- Onglet Fidélisation -->
                        <div id="tab-fidelisation" class="tab-content <?php echo e($activeTab !== 'fidelisation' ? 'hidden' : ''); ?>">
                            <?php echo $__env->make('entreprise.dashboard.tabs.fidelisation', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                        </div>

                        <!-- Onglet Abonnements -->
                        <div id="tab-abonnements" class="tab-content <?php echo e($activeTab !== 'abonnements' ? 'hidden' : ''); ?>">
                            <?php echo $__env->make('entreprise.dashboard.tabs.abonnements', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                        </div>

                        <!-- Onglet Services -->
                        <div id="tab-mes-services" class="tab-content <?php echo e($activeTab !== 'services' ? 'hidden' : ''); ?>">
                            <?php echo $__env->make('entreprise.dashboard.tabs.services', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                        </div>

                        <!-- Onglet Stock -->
                        <div id="tab-stock" class="tab-content <?php echo e($activeTab !== 'stock' ? 'hidden' : ''); ?>">
                            <?php echo $__env->make('entreprise.dashboard.tabs.stock', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                        </div>

                        <!-- Onglet Commandes Produits -->
                        <div id="tab-commandes" class="tab-content <?php echo e($activeTab !== 'commandes' ? 'hidden' : ''); ?>">
                            <?php echo $__env->make('entreprise.dashboard.tabs.commandes', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                        </div>
                        
                        <!-- Onglet Paramètres -->
                        <div id="tab-parametres" class="tab-content <?php echo e($activeTab !== 'parametres' ? 'hidden' : ''); ?>">
                            <?php echo $__env->make('entreprise.dashboard.tabs.parametres', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                        </div>
                        
                        <!-- Onglet Installer -->
                        <div id="tab-installer" class="tab-content <?php echo e($activeTab !== 'installer' ? 'hidden' : ''); ?>">
                            <?php echo $__env->make('entreprise.dashboard.tabs.installer', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                        </div>
                    </div>
                </main>
            </div>
        ...
        <script>
            ...
            const reloadableTabs = ['stock', 'commandes', 'reservations', 'agenda'];
                    ...
                    if (reloadableTabs.includes(tabName)) {
                        ...
                        if (now - lastReloadTime > RELOAD_DELAY) {
                            ...
                            fetch(`/m/<?php echo e($entreprise->slug); ?>/reload-tab/${tabName}`, {
                                method: 'GET',
                                headers: {
            ...
            let tab = urlParams.get('tab') || '<?php echo e($activeTab); ?>';
        ...
        <?php echo $__env->make('entreprise.dashboard.tabs.services-modal-content', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
...
<?php /**PATH /var/www/html/resources/views/entreprise/dashboard/index.blade.php ENDPATH**/ ?>