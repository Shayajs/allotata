@php
    ...
    $iconPath = $icons[$condition['icon'] ?? 'pencil'] ?? $icons['pencil'];
@endphp
...
<div class="flex items-center gap-3 p-3 rounded-lg {{ $condition['completed'] ? 'bg-green-50 dark:bg-green-900/20' : 'bg-white dark:bg-slate-800' }}">
    @if($condition['completed'])
        <div class="flex-shrink-0 w-7 h-7 rounded-full bg-green-500 flex items-center justify-center">
    ...
    @else
        <div class="flex-shrink-0 w-7 h-7 rounded-full border-2 border-blue-400 dark:border-blue-500 flex items-center justify-center bg-blue-50 dark:bg-blue-900/30">
