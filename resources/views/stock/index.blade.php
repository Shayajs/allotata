...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="scroll-smooth">
    <head>
        ...
        <title>Gestion du stock - {{ $entreprise->nom }}</title>
    ...
    <body class="bg-slate-50 dark:bg-slate-900 text-slate-900 dark:text-slate-100 antialiased transition-colors duration-200">
        ...
        <nav class="bg-white dark:bg-slate-800 border-b border-slate-200 dark:border-slate-700 sticky top-0 z-40">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex items-center justify-between h-16">
                    <a href="{{ route('entreprise.dashboard', $entreprise->slug) }}" class="text-2xl font-bold bg-gradient-to-r from-green-500 to-orange-500 bg-clip-text text-transparent">
                        Allo Tata
                    </a>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            <div class="mb-8">
                ...
                <p class="text-slate-600 dark:text-slate-400">
                    {{ $entreprise->nom }} • Gérez vos produits, stocks et promotions
                </p>
            </div>
        ...
        <div id="modal-produit" class="hidden fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 overflow-y-auto p-4">
            <div class="bg-white dark:bg-slate-800 rounded-2xl shadow-2xl p-6 max-w-2xl w-full">
                <div class="flex items-center justify-between mb-6">
