            ...
            <div class="flex flex-1 items-center gap-3 w-full md:w-auto">
                <div class="relative flex-1 md:w-64">
                    <input 
                        ...
                        class="w-full px-4 py-2 pl-10 border border-slate-300 dark:border-slate-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 bg-white dark:bg-slate-700 text-slate-900 dark:text-white"
                    >
