                ...
                <div class="bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-slate-200 dark:border-slate-700 p-6">
                    ...
                    <div id="editor-code" class="hidden">
                        <textarea name="body" id="body-code" rows="20"
                                  class="ui-textarea w-full px-4 py-3 border border-slate-300 dark:border-slate-600 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent dark:bg-slate-700 dark:text-white font-mono text-sm">{{ old('body', $template->body) }}</textarea>
                    </div>
            ...
            <div class="space-y-6">
                ...
                <div class="bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-slate-200 dark:border-slate-700 p-6">
                    ...
                    <button type="button" onclick="sendTestFromEdit()"
                            class="ui-btn-simple w-full mt-3 px-6 py-3 border border-slate-300 dark:border-slate-600 text-slate-700 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-700 font-medium rounded-xl transition flex items-center justify-center gap-2">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <form method="POST" action="{{ route('admin.email-templates.test', $template) }}">
            ...
            <div class="p-6 pt-0 flex gap-3">
                <button type="button" onclick="closeTestModal()" 
                        class="ui-btn-simple flex-1 px-4 py-2.5 text-slate-700 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-700 rounded-lg transition">
                    Annuler
                </button>
                <button type="submit" 
