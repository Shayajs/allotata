        ...
        <div class="p-6 space-y-6 max-h-[75vh] overflow-y-auto">
            ...
            <div>
                ...
                <textarea 
                    ...
                    class="ui-textarea w-full px-4 py-3 border border-slate-300 dark:border-slate-600 rounded-xl focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-purple-500 bg-white dark:bg-slate-900 text-slate-900 dark:text-white font-mono text-sm leading-relaxed resize-y"
                    spellcheck="false"
                ></textarea>
            </div>
