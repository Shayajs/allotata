...
@section('content')
    ...
    <div class="flex justify-between items-center mb-6">
        ...
        <form method="POST" action="{{ route('admin.audits.start') }}">
            @csrf
            <button type="submit" class="ui-btn-simple inline-flex items-center gap-2 px-4 py-2 bg-indigo-600 hover:bg-indigo-700 text-white rounded-lg font-medium text-sm transition-colors shadow-sm">
