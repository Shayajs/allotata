...
<div x-data="notesEditor({{ $note->id }})" x-cloak class="space-y-6">
    ...
    <div class="mb-4">
        <button 
            @click="goBack()"
            class="flex items-center gap-2 px-4 py-2 text-sm font-medium text-slate-700 dark:text-slate-300 hover:text-green-600 dark:hover:text-green-400 hover:bg-slate-100 dark:hover:bg-slate-800 rounded-lg transition"
        >
