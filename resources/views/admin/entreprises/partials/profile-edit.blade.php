            ...
            <div>
                ...
                <div class="space-y-3">
                    ...
                    <label class="flex items-center gap-3 p-3 border border-slate-200 dark:border-slate-600 rounded-lg">
                        ...
                        <span class="text-sm text-slate-900 dark:text-white">Sur rendez-vous uniquement (pas d’agenda client)</span>
                    </label>
                    <div>
                        <label class="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1">Message « sur RDV » affiché aux clients</label>
                        <textarea name="rdv_sur_demande_message" rows="2" maxlength="2000" class="w-full px-3 py-2 rounded-lg border border-slate-300 dark:border-slate-600 bg-white dark:bg-slate-800 text-slate-900 dark:text-white">{{ old('rdv_sur_demande_message', $entreprise->rdv_sur_demande_message) }}</textarea>
                    </div>
                    <label class="flex items-center gap-3 p-3 border border-slate-200 dark:border-slate-600 rounded-lg">
