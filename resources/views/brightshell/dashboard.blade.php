...
<div class="stats-grid">
    <div class="stat-card">
        ...
        <div class="stat-value">{{ number_format($stats['ca_mensuel'], 2, ',', ' ') }} €</div>
    </div>
    <div class="stat-card">
        <div class="stat-label">CA Annuel {{ date('Y') }}</div>
        <div class="stat-value">{{ number_format($stats['ca_annuel'], 2, ',', ' ') }} €</div>
    </div>
    <div class="stat-card">
        <div class="stat-label">Clients</div>
        <div class="stat-value text-accent">{{ $stats['clients'] }}</div>
    </div>
    <div class="stat-card">
        <div class="stat-label">Factures impayées</div>
        <div class="stat-value {{ $stats['factures_impayees'] > 0 ? 'warning' : 'success' }}">{{ $stats['factures_impayees'] }}</div>
    </div>
</div>
...
<div class="grid grid-2 mb-4">
    <div class="card">
        ...
        <div class="progress">
            <div class="progress-bar {{ $progressTVA > 80 ? ($progressTVA > 95 ? 'danger' : 'warning') : '' }}" style="width: {{ $progressTVA }}%"></div>
        </div>
        <p class="text-muted text-sm mt-2">
            {{ number_format($stats['ca_annuel'], 0, ',', ' ') }} € / {{ number_format($stats['seuil_tva'], 0, ',', ' ') }} € ({{ number_format($progressTVA, 1) }}%)
        </p>
    </div>
    ...
    <div class="card">
        <div class="card-header">
            ...
            <span class="badge badge-info">{{ number_format($stats['seuil_micro'], 0, ',', ' ') }} €</span>
        </div>
        @php $progressMicro = $stats['seuil_micro'] > 0 ? min(100, ($stats['ca_annuel'] / $stats['seuil_micro']) * 100) : 0; @endphp
        <div class="progress">
            <div class="progress-bar {{ $progressMicro > 80 ? 'warning' : '' }}" style="width: {{ $progressMicro }}%"></div>
        </div>
        <p class="text-muted text-sm mt-2">
            {{ number_format($stats['ca_annuel'], 0, ',', ' ') }} € / {{ number_format($stats['seuil_micro'], 0, ',', ' ') }} € ({{ number_format($progressMicro, 1) }}%)
        </p>
    </div>
</div>
...
<div class="card mb-4">
    ...
    <div class="grid grid-3">
        <div>
            ...
            <p class="text-accent" style="font-size: 1.5rem; font-weight: 600;">{{ number_format($stats['ca_annuel'], 2, ',', ' ') }} €</p>
        </div>
        <div>
            <p class="text-muted text-xs" style="text-transform: uppercase; letter-spacing: 1px;">Taux</p>
            <p class="text-accent" style="font-size: 1.5rem; font-weight: 600;">{{ ($stats['taux_cotisations'] * 100) }}%</p>
        </div>
        <div>
            <p class="text-muted text-xs" style="text-transform: uppercase; letter-spacing: 1px;">Cotisations estimées</p>
            <p class="text-warning" style="font-size: 1.5rem; font-weight: 600;">{{ number_format($stats['ca_annuel'] * $stats['taux_cotisations'], 2, ',', ' ') }} €</p>
        </div>
    </div>
</div>
...
<div class="grid grid-4">
    <a href="{{ route('brightshell.clients.create') }}" class="card" style="text-decoration: none; color: inherit;">
    ...
    <a href="{{ route('brightshell.devis.create') }}" class="card" style="text-decoration: none; color: inherit;">
        <div class="flex items-center gap-4">
    ...
    <a href="{{ route('brightshell.factures.create') }}" class="card" style="text-decoration: none; color: inherit;">
        <div class="flex items-center gap-4">
    ...
    <a href="{{ route('brightshell.mailing.compose') }}" class="card" style="text-decoration: none; color: inherit;">
        <div class="flex items-center gap-4">
...
<div class="grid grid-4">
    <a href="{{ route('brightshell.taches') }}" class="card" style="text-decoration: none; color: inherit;">
        <div class="flex items-center gap-4">
    ...
    <a href="{{ route('brightshell.notes') }}" class="card" style="text-decoration: none; color: inherit;">
        <div class="flex items-center gap-4">
    ...
    <a href="{{ route('brightshell.agenda') }}" class="card" style="text-decoration: none; color: inherit;">
        <div class="flex items-center gap-4">
    ...
    <a href="{{ route('brightshell.legals') }}" class="card" style="text-decoration: none; color: inherit;">
        <div class="flex items-center gap-4">
            <div style="width: 48px; height: 48px; background: rgba(91, 188, 228, 0.15); border-radius: 12px; display: flex; align-items: center; justify-content: center;">
    ...
    <a href="{{ route('brightshell.documents') }}" class="card" style="text-decoration: none; color: inherit;">
        <div class="flex items-center gap-4">
    ...
    <a href="{{ route('brightshell.statistiques') }}" class="card" style="text-decoration: none; color: inherit;">
        <div class="flex items-center gap-4">
    ...
    <a href="{{ route('brightshell.fournisseurs') }}" class="card" style="text-decoration: none; color: inherit;">
        <div class="flex items-center gap-4">
    ...
    <a href="{{ route('brightshell.achats.create') }}" class="card" style="text-decoration: none; color: inherit;">
        <div class="flex items-center gap-4">
    ...
    <a href="{{ route('brightshell.exports') }}" class="card" style="text-decoration: none; color: inherit;">
        <div class="flex items-center gap-4">
