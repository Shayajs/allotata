                        ...
                        <div class="mt-4 border-2 border-dashed border-green-300 dark:border-green-700 rounded-xl bg-green-50/50 dark:bg-green-900/10 p-4">
                            <div class="flex items-center gap-3 mb-2">
                                ...
                                <div class="flex-1">
                                    ...
                                    <p class="text-lg font-bold text-green-600 dark:text-green-400">{{ number_format($entreprise->tarif_horaire, 0, ',', ' ') }} €/h</p>
                                </div>
                            </div>
                            @if($entreprise->prestation_libre_description)
                                <p class="text-xs text-slate-600 dark:text-slate-400 mb-3">{{ $entreprise->prestation_libre_description }}</p>
                            @endif
                            <a href="{{ route('messagerie.show', $entreprise->slug) }}" class="block w-full text-center px-4 py-2 bg-green-600 hover:bg-green-700 text-white text-sm font-semibold rounded-lg transition">
                    ...
                    <div class="p-4 space-y-4">
                        ...
                        @if($entreprise->prestation_libre_active && $entreprise->tarif_horaire)
                            <div class="mt-4 border-2 border-dashed border-green-300 dark:border-green-700 rounded-xl bg-green-50/50 dark:bg-green-900/10 p-3">
                                ...
                                <p class="text-sm font-bold text-green-600 dark:text-green-400 mb-1">{{ number_format($entreprise->tarif_horaire, 0, ',', ' ') }} €/h</p>
                                @if($entreprise->prestation_libre_description)
                                    <p class="text-xs text-slate-500 dark:text-slate-400 mb-2">{{ $entreprise->prestation_libre_description }}</p>
                                @endif
                                <a href="{{ route('messagerie.show', $entreprise->slug) }}" class="block w-full text-center px-3 py-1.5 bg-green-600 hover:bg-green-700 text-white text-xs font-semibold rounded-lg transition">
                                    Contacter
                                </a>
                            </div>
                        @endif
                            ...
                            <div class="mb-6">
                                ...
                                <div class="flex items-center gap-6 text-lg">
                                    <span class="text-slate-600 dark:text-slate-400 flex items-center gap-2">
                                        ...
                                        <span id="service-duree">{{ $firstService->duree_formatee }}</span>
                                    </span>
