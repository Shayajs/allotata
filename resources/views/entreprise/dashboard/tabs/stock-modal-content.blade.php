        ...
        <div class="flex min-h-screen items-center justify-center p-4 text-center">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2">
                ...
                <div class="p-8">
                    ...
                    <form action="{{ route('stock.produit.store', $entreprise->slug) }}" method="POST" enctype="multipart/form-data" id="produit-form">
                        @csrf
...
<script>
    ...
    async function uploadImagesImmediatelyProduit(files) {
        ...
        const url = '{{ route("stock.produit.image.upload", ["slug" => $entreprise->slug, "produitId" => ":produitId"]) }}'
    ...
    function setImageAsCoverProduit(produitId, imageId, isCurrentlyCover) {
        ...
        const url = '{{ route("stock.produit.image.cover", ["slug" => $entreprise->slug, "produitId" => ":produitId", "imageId" => ":imageId"]) }}'
    ...
    function deleteProduitImage(produitId, imageId) {
        ...
        const url = '{{ route("stock.produit.image.delete", ["slug" => $entreprise->slug, "produitId" => ":produitId", "imageId" => ":imageId"]) }}'
            .replace(':produitId', produitId)
            .replace(':imageId', imageId);
