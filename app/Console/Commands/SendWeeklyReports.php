...
class SendWeeklyReports extends Command
{
     ...
     * @var string
     */
    protected $description = 'Envoyer les rapports hebdomadaires aux gérants d\'entreprises';
    ...
    public function handle()
    {
        ...
        foreach ($entreprises as $entreprise) {
            if ($service->sendWeeklyReport($entreprise)) {
                $sentCount++;
                $this->info("Rapport hebdomadaire envoyé pour l'entreprise: {$entreprise->nom}");
            } else {
                $errorCount++;
